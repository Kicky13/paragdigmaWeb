    ...
    return function e(t, n, r) {
        ...
        3: [function(t, e, n) {
            ...
            t("es6-promise").polyfill(), r.prototype.open = function() {
                ...
                function t(t) {
                    i.isBusy || null === o && 1 === t.touches.length && (!i.isOpened && t.touches[0].clientX > 30 || (o = t.touches[0].identifier, u = t.touches[0].clientX, c = t.touches[0].clientY, a = i.currentWidth, l = !1, f = !1, d = -999, h = -999, s.addEventListener("touchmove", e), s.addEventListener("touchcancel", n), s.addEventListener("touchend", n)))
                }

                function e(t) {
                    for (var e = 0; e < t.changedTouches.length; e++)
                        if (o === t.changedTouches[e].identifier) {
