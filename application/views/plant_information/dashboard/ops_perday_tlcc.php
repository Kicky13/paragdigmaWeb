    ...
    <nav class="navbar navbar-inverse my_margin">
        <div class="col-md-6 container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="<?= base_url() ?>index.php/master_data/tlcc">TLCC Yield Report</a>
            </div>
        </div>
        <div class="col-md-6"> <!--   container-fluid -->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li role="separator" class="divider"></li>
                                <li class="active"><a href="<?= base_url() ?>index.php/plant_dashboard/tlcc">TLCC</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
...
<script>
    ...
    function Btn_periode(periode) {
        var url = "<?= base_url() ?>index.php/plant_dashboard/tlcc";
