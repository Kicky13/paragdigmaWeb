    ...
    <nav class="navbar navbar-inverse my_margin" style="margin-bottom: 2px;">
        <div class="col-md-6 container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="javascript:void(0)">Gresik Inventory Report</a>
            </div>
        </div>
        <div class="col-md-6">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?= base_url() ?>index.php/plant_dashboard/dashboard_sp">Padang</a></li>
                            <li role="separator" class="divider"></li>

                            <li class="active"><a href="<?= base_url() ?>index.php/plant_dashboard/dashboard_sg">Gresik</a></li>
                            <li role="separator" class="divider"></li>
...
<div class="col-md-12 col-xs-12">
    <div style="text-align: center;"><h3 style="margin-top: 2px"><b>SG : Cement Inventory Report</b></h3></div>
