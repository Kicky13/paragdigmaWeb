...
<script>
    ...
    $("#load").click(function () {        
        $.ajax({
            url: 'plant_dashboard/ops_day_SGR/<?php echo $tahun; ?>/<?php echo $bulan; ?>',
            type: 'GET',
            success: function (res) {
                ...
                for (var i = 0, ilen = mine.mydata.length; i < ilen; i++) {
                    ...
                    row[2] = mine.mydata[i].FM1_PROD;
                    row[3] = mine.mydata[i].FM2_PROD;
    ...
    function Btn_periode(periode) {
        var url = "<?= base_url() ?>index.php/plant_dashboard/rembang";
