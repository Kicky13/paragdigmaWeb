    ...
    <nav class="navbar navbar-inverse my_margin" style="margin-bottom: 2px;">
        <div class="col-md-6 container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="javascript:void(0)">Tonasa Inventory Report</a>
            </div>
        </div>
        <div class="col-md-6">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="<?= base_url() ?>index.php/plant_dashboard/dashboard_st">Tonasa</a></li>
                            <li role="separator" class="divider"></li>
...
<div class="col-md-12 col-xs-12">
    <div style="text-align: center;"><h3 style="margin-top: 2px"><b>ST : Cement Inventory Report</b></h3></div>
