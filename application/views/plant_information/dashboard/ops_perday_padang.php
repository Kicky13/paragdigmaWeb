    ...
    <nav class="navbar navbar-inverse my_margin">
        <div class="col-md-6 container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="<?= base_url() ?>index.php/master_data/tlcc">Padang Yield Report</a>
            </div>
        </div>
        <div class="col-md-6"> <!--   container-fluid -->
                ...
                <div class="col-md-3 collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="float: right;">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="<?= base_url() ?>index.php/plant_dashboard/padang">Padang</a></li>
...
<script>
    ...
    hot = new Handsontable($container[0], {
        ...
        data: [
            ['Date', 'Yield in %', '', '', '', '', '', '', '', '', ''],
            ['', 'KL2', 'KL3', 'KL4', 'KL5', 'FM2', 'FM3', 'FM41', 'FM42', 'FM51', 'FM52', 'FMDM' ]
        ],
        mergeCells: [
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'plant_dashboard/ops_day_SP/<?php echo $tahun; ?>/<?php echo $bulan; ?>',
            type: 'GET',
            success: function (res) {
                var mine = JSON.parse(res);
                var data = [], row;
                data[0] = ['Date', 'Yield in %', '', '', '', '', '', '', '', '', ''];
                data[1] = ['', 'KL2', 'KL3', 'KL4', 'KL5', 'FM2', 'FM3', 'FM41', 'FM42', 'FM51', 'FM52', 'FMDM' ];
                for (var i = 0, ilen = mine.mydata.length; i < ilen; i++) {
                    ...
                    row[11] = mine.mydata[i].FMDM_PROD;
    ...
    function Btn_periode(periode) {
        var url = "<?= base_url() ?>index.php/plant_dashboard/padang";
