...
<script>
    $(function () {
        $('#btn_prod_semen').click(function () {
            window.location.href = 'index.php/plant_tonasa/prod_semen';
        });
        $('#btn_prod_klin').click(function () {
            window.location.href = 'index.php/plant_tonasa/klin_semen';
        });
        ...
        $('#btnTable').click(function () {
            window.location.href = 'index.php/plant_tonasa/prod_silica';
        });
    });
    $('#Tahun_<?php
...
?>').addClass('active btn-danger');
    ...
    function Btn_Tahun(tahun) {
        var url = "<?= base_url() ?>index.php/plant_tonasa/klin_semen";
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        <div style="margin-top: 15px;">
                            ...
                            $Query = $oracle->query("SELECT * FROM (SELECT TO_CHAR(DATE_PROD, 'YYYY-MM-DD') AS DATE_PROD FROM PIS_ST_PRODDAILY ORDER BY DATE_PROD DESC) WHERE ROWNUM = 1");
...
//                            echo 'Last Update on : ' . date_format($tanggal, "d F Y");
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="<?= base_url() ?>index.php/plant_tonasa/klin_semen">Tonasa</a></li>
                            <li role="separator" class="divider"></li>
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($klinData["$thn-$my_month"])) {
                        $klinData["$thn-$my_month"]['tonasa2'] = 0;
                        $klinData["$thn-$my_month"]['tonasa3'] = 0;
                        $klinData["$thn-$my_month"]['tonasa4'] = 0;
                        $klinData["$thn-$my_month"]['tonasa5'] = 0;
                    }
                }

                $total_upto_year_tns = (array_sum(($klinData["$thn-01"]))) + (array_sum(($klinData["$thn-02"]))) + (array_sum(($klinData["$thn-03"]))) + (array_sum(($klinData["$thn-04"]))) + (array_sum(($klinData["$thn-05"]))) + (array_sum(($klinData["$thn-06"]))) + (array_sum(($klinData["$thn-07"]))) + (array_sum(($klinData["$thn-08"]))) + (array_sum(($klinData["$thn-09"]))) + (array_sum(($klinData["$thn-10"]))) + (array_sum(($klinData["$thn-11"]))) + (array_sum(($klinData["$thn-12"])));

                $total_rkap_year_tns = ($DProduction[1]['clinker']) + ($DProduction[2]['clinker']) + ($DProduction[3]['clinker']) + ($DProduction[4]['clinker']) + ($DProduction[5]['clinker']) + ($DProduction[6]['clinker']) + ($DProduction[7]['clinker']) + ($DProduction[8]['clinker']) + ($DProduction[9]['clinker']) + ($DProduction[10]['clinker']) + ($DProduction[11]['clinker']) + ($DProduction[12]['clinker']);
                echo number_format($total_rkap_year_tns)
                ?> T</div>
            <?php
            $hasil_year_tns = ($total_upto_year_tns / $total_rkap_year_tns) * 100;
            if ($hasil_year_tns < 100) {
                echo '<div class="col-xs-12 noPadding" align="center" style="color: #f00"><h4>' . number_format($hasil_year_tns, 2, ",", ".") . '%</h4></div>';
            } else {
                echo '<div class="col-xs-12 noPadding" align="center" style="color: #6bbb3e"><h4>' . number_format($hasil_year_tns, 2, ",", ".") . '%</h4></div>';
            }
            ?>
            Real : 
            <span class="row-xs-2 noPadding" align="left"  style="font-weight: bold;"><?php echo number_format($total_upto_year_tns) ?> T</span>
        </div>
    </div>
    <div class="col-xs-6 col-md-2 noPadding" >
        <div class="headside cubesRun" > 
            <div class="col-xs-2 noPadding"  style="font-weight: bold;">TN II</div>
            <div class="col-xs-10 noPadding" align="right">RKAP :
                <?php
                for ($i = 1; $i <= 12; $i++) {
                    if (strlen($i) < 2) {
                    ...
                    if (empty($klinData["$thn-$my_month"]['tonasa2'])) {
                        $klinData["$thn-$my_month"]['tonasa2'] = 0;
                        $klinData["$thn-$my_month"]['tonasa3'] = 0;
                        $klinData["$thn-$my_month"]['tonasa4'] = 0;
                        $klinData["$thn-$my_month"]['tonasa5'] = 0;
                ...
                if (empty($rkap_klin[$thn]['tonasa2'])) {
                    $rkap_klin[$thn]['tonasa2'] = 0;
                }
                $total_rkap_year_tns2 = $rkap_klin[$thn]['tonasa2'];
                $total_upto_year_tns2 = (($klinData["$thn-01"]['tonasa2']) + ($klinData["$thn-02"]['tonasa2']) + ($klinData["$thn-03"]['tonasa2'])) + (($klinData["$thn-04"]['tonasa2']) + ($klinData["$thn-05"]['tonasa2']) + ($klinData["$thn-06"]['tonasa2'])) + (($klinData["$thn-07"]['tonasa2']) + ($klinData["$thn-08"]['tonasa2']) + ($klinData["$thn-09"]['tonasa2'])) + (($klinData["$thn-10"]['tonasa2']) + ($klinData["$thn-11"]['tonasa2']) + ($klinData["$thn-12"]['tonasa2']));

                echo number_format($total_rkap_year_tns2)
                ?> T</div>
            <?php
            $hasil_year_tns2 = @($total_upto_year_tns2 / $total_rkap_year_tns2) * 100;
            if ($hasil_year_tns2 < 100) {
                echo '<div class="col-xs-12 noPadding" align="center" style="color: #f00"><h4>' . number_format($hasil_year_tns2, 2, ",", ".") . '%</h4></div>';
            } else {
                echo '<div class="col-xs-12 noPadding" align="center" style="color: #6bbb3e"><h4>' . number_format($hasil_year_tns2, 2, ",", ".") . '%</h4></div>';
            }
            ?>
            Real : 
            <span class="row-xs-2 noPadding" align="left"  style="font-weight: bold;"><?php echo number_format($total_upto_year_tns2) ?> T</span>
        </div>
    </div>
    <div class="col-xs-6 col-md-2 noPadding" >
        <div class="headside cubesRun" > 
            <div class="col-xs-2 noPadding"  style="font-weight: bold;">TN III</div>
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                <?php
                for ($i = 1; $i <= 12; $i++) {
                    if (strlen($i) < 2) {
                    ...
                    if (empty($klinData["$thn-$my_month"]['tonasa3'])) {
                        $klinData["$thn-$my_month"]['tonasa2'] = 0;
                        $klinData["$thn-$my_month"]['tonasa3'] = 0;
                        $klinData["$thn-$my_month"]['tonasa4'] = 0;
                        $klinData["$thn-$my_month"]['tonasa5'] = 0;
                ...
                if (empty($rkap_klin[$thn]['tonasa3'])) {
                    $rkap_klin[$thn]['tonasa3'] = 0;
                }
                $total_rkap_year_tns3 = $rkap_klin[$thn]['tonasa3'];
                $total_upto_year_tns3 = (($klinData["$thn-01"]['tonasa3']) + ($klinData["$thn-02"]['tonasa3']) + ($klinData["$thn-03"]['tonasa3'])) + (($klinData["$thn-04"]['tonasa3']) + ($klinData["$thn-05"]['tonasa3']) + ($klinData["$thn-06"]['tonasa3'])) + (($klinData["$thn-07"]['tonasa3']) + ($klinData["$thn-08"]['tonasa3']) + ($klinData["$thn-09"]['tonasa3'])) + (($klinData["$thn-10"]['tonasa3']) + ($klinData["$thn-11"]['tonasa3']) + ($klinData["$thn-12"]['tonasa3']));

                echo number_format($total_rkap_year_tns3)
                ?> T</div>
            <?php
            $hasil_year_tns3 = @($total_upto_year_tns3 / $total_rkap_year_tns3) * 100;
            if ($hasil_year_tns3 < 100) {
                echo '<div class="col-xs-12 noPadding" align="center" style="color: #f00"><h4>' . number_format($hasil_year_tns3, 2, ",", ".") . '%</h4></div>';
            } else {
                echo '<div class="col-xs-12 noPadding" align="center" style="color: #6bbb3e"><h4>' . number_format($hasil_year_tns3, 2, ",", ".") . '%</h4></div>';
            }
            ?>
            Real : 
            <span class="row-xs-2 noPadding" align="left"  style="font-weight: bold;"><?php echo number_format($total_upto_year_tns3) ?> T</span>
        </div>
    </div>
    <div class="col-xs-6 col-md-2 noPadding" >
        <div class="headside cubesRun" > 
            <div class="col-xs-2 noPadding"  style="font-weight: bold;">TN IV</div>
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                <?php
                for ($i = 1; $i <= 12; $i++) {
                    if (strlen($i) < 2) {
                    ...
                    if (empty($klinData["$thn-$my_month"]['tonasa4'])) {
                        $klinData["$thn-$my_month"]['tonasa2'] = 0;
                        $klinData["$thn-$my_month"]['tonasa3'] = 0;
                        $klinData["$thn-$my_month"]['tonasa4'] = 0;
                        $klinData["$thn-$my_month"]['tonasa5'] = 0;
                ...
                if (empty($rkap_klin[$thn]['tonasa4'])) {
                    $rkap_klin[$thn]['tonasa4'] = 0;
                }
                $total_rkap_year_tns4 = $rkap_klin[$thn]['tonasa4'];
                $total_upto_year_tns4 = (($klinData["$thn-01"]['tonasa4']) + ($klinData["$thn-02"]['tonasa4']) + ($klinData["$thn-03"]['tonasa4'])) + (($klinData["$thn-04"]['tonasa4']) + ($klinData["$thn-05"]['tonasa4']) + ($klinData["$thn-06"]['tonasa4'])) + (($klinData["$thn-07"]['tonasa4']) + ($klinData["$thn-08"]['tonasa4']) + ($klinData["$thn-09"]['tonasa4'])) + (($klinData["$thn-10"]['tonasa4']) + ($klinData["$thn-11"]['tonasa4']) + ($klinData["$thn-12"]['tonasa4']));
                echo number_format($total_rkap_year_tns4)
                ?> T</div>
            <?php
            $hasil_year_tns4 = @($total_upto_year_tns4 / $total_rkap_year_tns4) * 100;
            if ($hasil_year_tns4 < 100) {
                echo '<div class="col-xs-12 noPadding" align="center" style="color: #f00"><h4>' . number_format($hasil_year_tns4, 2, ",", ".") . '%</h4></div>';
            } else {
                echo '<div class="col-xs-12 noPadding" align="center" style="color: #6bbb3e"><h4>' . number_format($hasil_year_tns4, 2, ",", ".") . '%</h4></div>';
            }
            ?>
            Real : 
            <span class="row-xs-2 noPadding" align="left"  style="font-weight: bold;"><?php echo number_format($total_upto_year_tns4) ?> T</span>
        </div>
    </div>
    <div class="col-xs-6 col-md-2 noPadding" >
        <div class="headside cubesRun" > 
            <div class="col-xs-2 noPadding"  style="font-weight: bold;">TN V </div>
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                <?php
                for ($i = 1; $i <= 12; $i++) {
                    if (strlen($i) < 2) {
                    ...
                    if (empty($klinData["$thn-$my_month"]['tonasa5'])) {
                        $klinData["$thn-$my_month"]['tonasa2'] = 0;
                        $klinData["$thn-$my_month"]['tonasa3'] = 0;
                        $klinData["$thn-$my_month"]['tonasa4'] = 0;
                        $klinData["$thn-$my_month"]['tonasa5'] = 0;
                ...
                if (empty($rkap_klin[$thn]['tonasa5'])) {
                    $rkap_klin[$thn]['tonasa5'] = 0;
                }
                $total_rkap_year_tns5 = $rkap_klin[$thn]['tonasa5'];
                $total_upto_year_tns5 = (($klinData["$thn-01"]['tonasa5']) + ($klinData["$thn-02"]['tonasa5']) + ($klinData["$thn-03"]['tonasa5'])) + (($klinData["$thn-04"]['tonasa5']) + ($klinData["$thn-05"]['tonasa5']) + ($klinData["$thn-06"]['tonasa5'])) + (($klinData["$thn-07"]['tonasa5']) + ($klinData["$thn-08"]['tonasa5']) + ($klinData["$thn-09"]['tonasa5'])) + (($klinData["$thn-10"]['tonasa4']) + ($klinData["$thn-11"]['tonasa4']) + ($klinData["$thn-12"]['tonasa4']));
                echo number_format($total_rkap_year_tns5)
                ?> T</div>
            <?php
            $hasil_year_tns5 = @($total_upto_year_tns5 / $total_rkap_year_tns5) * 100;
            if ($hasil_year_tns5 < 100) {
                echo '<div class="col-xs-12 noPadding" align="center" style="color: #f00"><h4>' . number_format($hasil_year_tns5, 2, ",", ".") . '%</h4></div>';
            } else {
                echo '<div class="col-xs-12 noPadding" align="center" style="color: #6bbb3e"><h4>' . number_format($hasil_year_tns5, 2, ",", ".") . '%</h4></div>';
            }
            ?>
            Real : 
            <span class="row-xs-2 noPadding" align="left"  style="font-weight: bold;"><?php echo number_format($total_upto_year_tns5) ?> T</span>
        </div>
    </div>
</div>
<div class="row">
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($klinData["$thn-01"]) || !empty($klinData["$thn-02"]) || !empty($klinData["$thn-03"])) {
                            $tot_tns2 = (($klinData["$thn-01"]['tonasa2']) + ($klinData["$thn-02"]['tonasa2']) + ($klinData["$thn-03"]['tonasa2']));
                            $tot_tns3 = (($klinData["$thn-01"]['tonasa3']) + ($klinData["$thn-02"]['tonasa3']) + ($klinData["$thn-03"]['tonasa3']));
                            $tot_tns4 = (($klinData["$thn-01"]['tonasa4']) + ($klinData["$thn-02"]['tonasa4']) + ($klinData["$thn-03"]['tonasa4']));
                            $tot_tns5 = (($klinData["$thn-01"]['tonasa5']) + ($klinData["$thn-02"]['tonasa5']) + ($klinData["$thn-03"]['tonasa5']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($klinData["$thn-04"]) || !empty($klinData["$thn-05"]) || !empty($klinData["$thn-06"])) {
                            $tot_tns2 = (($klinData["$thn-04"]['tonasa2']) + ($klinData["$thn-05"]['tonasa2']) + ($klinData["$thn-06"]['tonasa2']));
                            $tot_tns3 = (($klinData["$thn-04"]['tonasa3']) + ($klinData["$thn-05"]['tonasa3']) + ($klinData["$thn-06"]['tonasa3']));
                            $tot_tns4 = (($klinData["$thn-04"]['tonasa4']) + ($klinData["$thn-05"]['tonasa4']) + ($klinData["$thn-06"]['tonasa4']));
                            $tot_tns5 = (($klinData["$thn-04"]['tonasa5']) + ($klinData["$thn-05"]['tonasa5']) + ($klinData["$thn-06"]['tonasa5']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($klinData["$thn-07"]) || !empty($klinData["$thn-08"]) || !empty($klinData["$thn-09"])) {
                            $tot_tns2 = (($klinData["$thn-07"]['tonasa2']) + ($klinData["$thn-08"]['tonasa2']) + ($klinData["$thn-09"]['tonasa2']));
                            $tot_tns3 = (($klinData["$thn-07"]['tonasa3']) + ($klinData["$thn-08"]['tonasa3']) + ($klinData["$thn-09"]['tonasa3']));
                            $tot_tns4 = (($klinData["$thn-07"]['tonasa4']) + ($klinData["$thn-08"]['tonasa4']) + ($klinData["$thn-09"]['tonasa4']));
                            $tot_tns5 = (($klinData["$thn-07"]['tonasa5']) + ($klinData["$thn-08"]['tonasa5']) + ($klinData["$thn-09"]['tonasa5']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($klinData["$thn-10"]) || !empty($klinData["$thn-11"]) || !empty($klinData["$thn-12"])) {
                            $tot_tns2 = (($klinData["$thn-10"]['tonasa2']) + ($klinData["$thn-11"]['tonasa2']) + ($klinData["$thn-12"]['tonasa2']));
                            $tot_tns3 = (($klinData["$thn-10"]['tonasa3']) + ($klinData["$thn-11"]['tonasa3']) + ($klinData["$thn-12"]['tonasa3']));
                            $tot_tns4 = (($klinData["$thn-10"]['tonasa4']) + ($klinData["$thn-11"]['tonasa4']) + ($klinData["$thn-12"]['tonasa4']));
                            $tot_tns5 = (($klinData["$thn-10"]['tonasa5']) + ($klinData["$thn-11"]['tonasa5']) + ($klinData["$thn-12"]['tonasa5']));
