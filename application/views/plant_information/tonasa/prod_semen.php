...
?>').addClass('active btn-danger');
    ...
    function Btn_Tahun(tahun) {
        var url = "<?= base_url() ?>index.php/plant_tonasa/prod_semen";
...
//                            echo 'Last Update on : ' . date_format($tanggal, "d F Y");
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="<?= base_url() ?>index.php/plant_tonasa/prod_semen">Tonasa</a></li>
                            <li role="separator" class="divider"></li>
    ...
    <div class="col-xs-6 col-md-4 noPadding" >
        <div class=" headside cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                $myData["$thn-$my_month"]['tonasa2'] = 0;
                $myData["$thn-$my_month"]['tonasa3'] = 0;
                $myData["$thn-$my_month"]['tonasa4'] = 0;
                $myData["$thn-$my_month"]['tonasa5'] = 0;
                }
                }
                $total_upto_year_tns = (array_sum(($myData["$thn-01"]))) + (array_sum(($myData["$thn-02"]))) + (array_sum(($myData["$thn-03"]))) + (array_sum(($myData["$thn-04"]))) + (array_sum(($myData["$thn-05"]))) + (array_sum(($myData["$thn-06"]))) + (array_sum(($myData["$thn-07"]))) + (array_sum(($myData["$thn-08"]))) + (array_sum(($myData["$thn-09"]))) + (array_sum(($myData["$thn-10"]))) + (array_sum(($myData["$thn-11"]))) + (array_sum(($myData["$thn-12"])));

                $total_rkap_year_tns = ($DProduction[1]['cement']) + ($DProduction[2]['cement']) + ($DProduction[3]['cement']) + ($DProduction[4]['cement']) + ($DProduction[5]['cement']) + ($DProduction[6]['cement']) + ($DProduction[7]['cement']) + ($DProduction[8]['cement']) + ($DProduction[9]['cement']) + ($DProduction[10]['cement']) + ($DProduction[11]['cement']) + ($DProduction[12]['cement']);
        ...
        <div class="headside cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP :
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($myData["$thn-$my_month"]['tonasa3'])) {
                        $myData["$thn-$my_month"]['tonasa2'] = 0;
                        $myData["$thn-$my_month"]['tonasa3'] = 0;
                        $myData["$thn-$my_month"]['tonasa4'] = 0;
                        $myData["$thn-$my_month"]['tonasa5'] = 0;
                ...
                if (empty($rkap_cement[$thn]['tonasa3'])) {
                    $rkap_cement[$thn]['tonasa3'] = 0;
                }


                $total_rkap_year_tns2 = $rkap_cement[$thn]['tonasa3'];
                $total_upto_year_tns2 = (($myData["$thn-01"]['tonasa3']) + ($myData["$thn-02"]['tonasa3']) + ($myData["$thn-03"]['tonasa3'])) + (($myData["$thn-04"]['tonasa3']) + ($myData["$thn-05"]['tonasa3']) + ($myData["$thn-06"]['tonasa3'])) + (($myData["$thn-07"]['tonasa3']) + ($myData["$thn-08"]['tonasa3']) + ($myData["$thn-09"]['tonasa3'])) + (($myData["$thn-10"]['tonasa3']) + ($myData["$thn-11"]['tonasa3']) + ($myData["$thn-12"]['tonasa3']));
        ...
        <div class="headside cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($myData["$thn-$my_month"]['tonasa4'])) {
                        $myData["$thn-$my_month"]['tonasa2'] = 0;
                        $myData["$thn-$my_month"]['tonasa3'] = 0;
                        $myData["$thn-$my_month"]['tonasa4'] = 0;
                        $myData["$thn-$my_month"]['tonasa5'] = 0;
                ...
                if (empty($rkap_cement[$thn]['tonasa4'])) {
                    $rkap_cement[$thn]['tonasa4'] = 0;
                }
                $total_rkap_year_tns3 = $rkap_cement[$thn]['tonasa4'];
                $total_upto_year_tns3 = (($myData["$thn-01"]['tonasa4']) + ($myData["$thn-02"]['tonasa4']) + ($myData["$thn-03"]['tonasa4'])) + (($myData["$thn-04"]['tonasa4']) + ($myData["$thn-05"]['tonasa4']) + ($myData["$thn-06"]['tonasa4'])) + (($myData["$thn-07"]['tonasa4']) + ($myData["$thn-08"]['tonasa4']) + ($myData["$thn-09"]['tonasa4'])) + (($myData["$thn-10"]['tonasa4']) + ($myData["$thn-11"]['tonasa4']) + ($myData["$thn-12"]['tonasa4']));
        ...
        <div class="headside cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($myData["$thn-$my_month"]['tonasa5'])) {
                        $myData["$thn-$my_month"]['tonasa2'] = 0;
                        $myData["$thn-$my_month"]['tonasa3'] = 0;
                        $myData["$thn-$my_month"]['tonasa4'] = 0;
                        $myData["$thn-$my_month"]['tonasa5'] = 0;
                ...
                if (empty($rkap_cement[$thn]['tonasa5'])) {
                    $rkap_cement[$thn]['tonasa5'] = 0;
                }

                $total_rkap_year_tns4 = $rkap_cement[$thn]['tonasa5'];
                $total_upto_year_tns4 = (($myData["$thn-01"]['tonasa5']) + ($myData["$thn-02"]['tonasa5']) + ($myData["$thn-03"]['tonasa5'])) + (($myData["$thn-04"]['tonasa5']) + ($myData["$thn-05"]['tonasa5']) + ($myData["$thn-06"]['tonasa5'])) + (($myData["$thn-07"]['tonasa5']) + ($myData["$thn-08"]['tonasa5']) + ($myData["$thn-09"]['tonasa5'])) + (($myData["$thn-10"]['tonasa5']) + ($myData["$thn-11"]['tonasa5']) + ($myData["$thn-12"]['tonasa5']));
    ...
    <div class="col-xs-6 col-md-2 noPadding" >
        <div class="headside cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                $total_rkap_year_tns5 = $rkap_cement[$thn]['tonasa5'];
                $total_upto_year_tns5 = (($myData["$thn-01"]['tonasa5']) + ($myData["$thn-02"]['tonasa5']) + ($myData["$thn-03"]['tonasa5'])) + (($myData["$thn-04"]['tonasa5']) + ($myData["$thn-05"]['tonasa5']) + ($myData["$thn-06"]['tonasa5'])) + (($myData["$thn-07"]['tonasa5']) + ($myData["$thn-08"]['tonasa5']) + ($myData["$thn-09"]['tonasa5'])) + (($myData["$thn-10"]['tonasa5']) + ($myData["$thn-11"]['tonasa5']) + ($myData["$thn-12"]['tonasa5']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($myData["$thn-01"]) || !empty($myData["$thn-02"]) || !empty($myData["$thn-03"])) {
                            $tot_tns2 = (($myData["$thn-01"]['tonasa3']) + ($myData["$thn-02"]['tonasa3']) + ($myData["$thn-03"]['tonasa3']));
                            $tot_tns3 = (($myData["$thn-01"]['tonasa4']) + ($myData["$thn-02"]['tonasa4']) + ($myData["$thn-03"]['tonasa4']));
                            $tot_tns4 = (($myData["$thn-01"]['tonasa5']) + ($myData["$thn-02"]['tonasa5']) + ($myData["$thn-03"]['tonasa5']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($myData["$thn-04"]) || !empty($myData["$thn-05"]) || !empty($myData["$thn-06"])) {
                            $tot_tns2 = (($myData["$thn-04"]['tonasa3']) + ($myData["$thn-05"]['tonasa3']) + ($myData["$thn-06"]['tonasa3']));
                            $tot_tns3 = (($myData["$thn-04"]['tonasa4']) + ($myData["$thn-05"]['tonasa4']) + ($myData["$thn-06"]['tonasa4']));
                            $tot_tns4 = (($myData["$thn-04"]['tonasa5']) + ($myData["$thn-05"]['tonasa5']) + ($myData["$thn-06"]['tonasa5']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($myData["$thn-07"]) || !empty($myData["$thn-08"]) || !empty($myData["$thn-09"])) {
                            $tot_tns2 = (($myData["$thn-07"]['tonasa3']) + ($myData["$thn-08"]['tonasa3']) + ($myData["$thn-09"]['tonasa3']));
                            $tot_tns3 = (($myData["$thn-07"]['tonasa4']) + ($myData["$thn-08"]['tonasa4']) + ($myData["$thn-09"]['tonasa4']));
                            $tot_tns4 = (($myData["$thn-07"]['tonasa5']) + ($myData["$thn-08"]['tonasa5']) + ($myData["$thn-09"]['tonasa5']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($myData["$thn-10"]) || !empty($myData["$thn-11"]) || !empty($myData["$thn-12"])) {
                            $tot_tns2 = (($myData["$thn-10"]['tonasa3']) + ($myData["$thn-11"]['tonasa3']) + ($myData["$thn-12"]['tonasa3']));
                            $tot_tns3 = (($myData["$thn-10"]['tonasa4']) + ($myData["$thn-11"]['tonasa4']) + ($myData["$thn-12"]['tonasa4']));
                            $tot_tns4 = (($myData["$thn-10"]['tonasa5']) + ($myData["$thn-11"]['tonasa5']) + ($myData["$thn-12"]['tonasa5']));
