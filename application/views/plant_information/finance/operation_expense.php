<section id="content" class="opex">	
	<div class="centering add_fix">
		<div class="col-md-12 nopadding" style="background:#F8F8F8;">

			<div class="col-md-12 nopadding" style="padding: 0 20px 0px 20px; margin-top: 6px;">
				<div class="col-md-3 nopadding">
					<span class="tittle_head" id="tittle_head">Operation Expense</span>
				</div>
			...
			<div class="col-md-12 nopadding" style="padding: 0 20px 12px 20px; margin-top: 12px;">
				<div class="col-md-6 nopadding col-xs-12" >
					<div class="chart" id="opexchart" style="min-height: 600px; width: 100%;position:relative;top:-20px;padding-left:0;"></div>
				</div>

				<div class="col-md-6 nopadding  col-xs-12">
					<div class="col-xs-12 scrollcostrev" style="padding-right:0;">
						<div class="col-md-6 bottom_clinker col-xs-12 blockopex" style="padding:0 7.5px 0 0">
			                <div class="col-xs-12 highlight nopadding block active" data-name="Operation Expense" rel="1" style="padding: 0; overflow: hidden;">
			                	<div class="inc" style="padding: 12px 10px 0px">
			                		<span class="bottom_header">General & Administration Expense</span>
			                	</div>
			                	...
			                	<div class="col-xs-12 nopadding growth" align="left" style="font-size: 14px; margin-top: 6px; height: 8px"></div>
			                </div>
						</div>
						<div class="col-md-6 bottom_cement col-xs-12 blockopex" style="padding:0 0 0 7.5px">
			                <div class="col-xs-12 highlight nopadding block" data-name="Operation Expense" rel="2" style="padding: 0; overflow: hidden;">
			                	<div class="inc" style="padding: 12px 10px 0px">
			                		<span class="bottom_header">Selling & Marketing Expense</span>
			                	</div>
			                	<div class="col-xs-12 nopadding" style="margin-top: 6px; padding-bottom: 5px">
			                		<div class="col-xs-7 nopadding" style="padding-left: 15px">
			                			<div class="col-xs-12 nopadding" >
					...
					<div class="col-xs-12 nopadding" style="padding: 0 0 0 15px">
						<div class="highlight tablecostrev" style="margin-top:0;">
...
<script src="assets/js/finance_opex.js"></script>
