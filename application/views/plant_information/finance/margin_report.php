			...
			<div class="col-md-12 nopadding" style="padding: 0 20px 12px 20px; margin-top: 12px;">
				...
				<div class='tableauPlaceholder' style='width: 100%; height: 850px;'>
					<object class='tableauViz' width='100%' height='850' style='display:none;'>
						<param name='host_url' value='http%3A%2F%2Ftableau.semenindonesia.com%2F' />
						<param name='embed_code_version' value='3' />
						<param name='site_root' value='' />
						<param name='name' value='DashboardBiayadanProfitabilitas&#47;6-MarginSummary' />
...
<script type='text/javascript' src='http://tableau.semenindonesia.com/javascripts/api/viz_v1.js'></script>
