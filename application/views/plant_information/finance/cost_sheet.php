<section id="content" class="income_statement">	
	<div class="centering add_fix">
		<div class="col-md-12 nopadding" style="background:#F8F8F8; margin-top: 6px;">

			<div class="col-md-12 nopadding" style="padding: 0 20px 0px 20px;">
				<div class="col-md-2 nopadding">
					<span class="tittle_head" id="tittle_head">Cost Sheet</span>
				</div>
				<div class="col-md-8 nopadding" align="center">
					Company
					...
					Material
						<select id="material" class="opco highlight_option">
							<option value="0010">Batu Kapur, Tambang</option>
							<option value="0030">Fine Limestone</option>
							<option value="0050">Ex Dryer (LS+CY)</option>
							<option value="0020">Tanah Liat, Tambang</option>
							<option value="0030">Fine Clay</option>
						</select>&nbsp;&nbsp;
					Month
				...
				<div class="col-md-2 nopadding" align="right" style="padding-top: 10px">
			...
			<div class="col-md-12 nopadding" style="padding: 0 20px 12px 20px; margin-top: 12px;">
				...
				<div class="col-md-6 nopadding col-xs-12">
					...
					<div class="col-xs-12 nopadding" style="margin-top: 12px">
						...
						<!-- <div class="col-xs-1 nopadding" align="center" style="padding-right: 10px;">
					...
					<div class="col-xs-12 nopadding" style="margin-top: 6px">
						<div class="chart" id="corchart" style="height:500px;width: 100%"></div>
					</div>

					<!-- <div class="col-xs-12 nopadding">
						<div class="col-md-4 bottom_clinker col-xs-4">
						...
						<div class="col-md-4 bottom_cement col-xs-4">
			                <div class="col-xs-12 highlight nopadding bottom_block">
			                	<div class="col-xs-12 nopadding" style="margin-top: 3px; padding: 10px 10px 0 10px">
						...
						<div class="col-md-4 bottom_sales col-xs-4" style="padding-right: 10px;">
			                <div class="col-xs-12 highlight nopadding bottom_block">
			                	<div class="col-xs-12 nopadding" style="margin-top: 3px; padding: 10px 10px 0 10px">
					...
					<div class="col-xs-12 nopadding" style="padding: 0 0 0 15px">
						<div class="highlight">
								<table class="table table-striped side_desc">
									<thead>
										<tr>
											<td rowspan="2" align="center" valign="center" width="150" style="border-right:1px solid #fff;line-height:50px">PLANT</td>
											<td class="side_actual" width="300" colspan="2" align="center">Actual</td>
											<td class="side_budget" width="300" colspan="2" align="center" style="border-left:1px solid #fff">Budget</td>
											<!-- <td rowspan="2" align="center" valign="center" width="50" style="border-left:1px solid #fff;line-height:50px">COST</td>
											<td rowspan="2" align="center" valign="center" width="50" style="border-left:1px solid #fff;line-height:50px">Trend</td> -->
										</tr>
										<tr>
											<td class="side_head1" width="100" align="center" style="border-right:1px solid #fff;">Cost Variable</td>
											<td class="side_head2" width="100" align="center" style="border-right:1px solid #fff;">Cost Fixed</td>
											<td class="side_head3" width="100" align="center" style="border-right:1px solid #fff;">Cost Variable</td>
											<td class="side_head4" width="100" align="center" style="border-right:1px solid #fff;">Cost Fixed</td>
										</tr>
									</thead>
									<tbody>
										<tr>
...
<style type="text/css">
	...
	.side_desc tbody td:first-child{
	    text-align: left;
	}
	.side_desc thead, .side_desc tbody tr {
	    display:table;
	    width:100%;
	    table-layout:fixed;
	}
...
<script src="assets/js/finance_cos.js"></script>
