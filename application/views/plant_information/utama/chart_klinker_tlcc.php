...
for ($i = 1; $i <= 12; $i++) {
    ...
    if (empty($klinDataTL["$thn-$my_month"])) {
        $klinDataTL["$thn-$my_month"]['tlcc1'] = 0;
    }
}

$total_rkap_q1 = ($DProductionTL[1]['clinker']) + ($DProductionTL[2]['clinker']) + ($DProductionTL[3]['clinker']);
$total_upto_q1 = (array_sum(($klinDataTL["$thn-01"]))) + (array_sum(($klinDataTL["$thn-02"]))) + (array_sum(($klinDataTL["$thn-03"])));
$hasil_q1 = ($total_upto_q1 / $total_rkap_q1) * 100;

$total_rkap_q2 = ($DProductionTL[4]['clinker']) + ($DProductionTL[5]['clinker']) + ($DProductionTL[6]['clinker']);
$total_upto_q2 = (array_sum(($klinDataTL["$thn-04"]))) + (array_sum(($klinDataTL["$thn-05"]))) + (array_sum(($klinDataTL["$thn-06"])));
$hasil_q2 = ($total_upto_q2 / $total_rkap_q2) * 100;

$total_rkap_q3 = ($DProductionTL[7]['clinker']) + ($DProductionTL[8]['clinker']) + ($DProductionTL[9]['clinker']);
$total_upto_q3 = (array_sum(($klinDataTL["$thn-07"]))) + (array_sum(($klinDataTL["$thn-08"]))) + (array_sum(($klinDataTL["$thn-09"])));
$hasil_q3 = ($total_upto_q3 / $total_rkap_q3) * 100;

$total_rkap_q4 = ($DProductionTL[10]['clinker']) + ($DProductionTL[11]['clinker']) + ($DProductionTL[12]['clinker']);
$total_upto_q4 = (array_sum(($klinDataTL["$thn-10"]))) + (array_sum(($klinDataTL["$thn-11"])))+ (array_sum(($klinDataTL["$thn-12"])));
            ...
            series: [
                {
                    ...
                    data: [<?php echo $klinDataTL["$thn-01"]['tlcc1']; echo ',';echo $klinDataTL["$thn-02"]['tlcc1']; echo ',';echo $klinDataTL["$thn-03"]['tlcc1']; echo ',';echo $klinDataTL["$thn-04"]['tlcc1']; echo ',';echo $klinDataTL["$thn-05"]['tlcc1']; echo ',';echo $klinDataTL["$thn-06"]['tlcc1']; echo ',';echo $klinDataTL["$thn-07"]['tlcc1']; echo ',';echo $klinDataTL["$thn-08"]['tlcc1']; echo ',';echo $klinDataTL["$thn-09"]['tlcc1']; echo ',';echo $klinDataTL["$thn-10"]['tlcc1']; echo ',';echo $klinDataTL["$thn-11"]['tlcc1']; echo ',';echo $klinDataTL["$thn-12"]['tlcc1'];echo ',';?>]
                },{
                    name: 'RKAP',
                    type: 'spline',
                    tooltip: {
                    ...
                    data: [<?php echo $DProductionTL[1]['clinker']; echo ',';echo $DProductionTL[2]['clinker']; echo ',';echo $DProductionTL[3]['clinker']; echo ',';echo $DProductionTL[4]['clinker']; echo ',';echo $DProductionTL[5]['clinker']; echo ',';echo $DProductionTL[6]['clinker']; echo ',';echo $DProductionTL[7]['clinker']; echo ',';echo $DProductionTL[8]['clinker']; echo ',';echo $DProductionTL[9]['clinker']; echo ',';echo $DProductionTL[10]['clinker']; echo ',';echo $DProductionTL[11]['clinker']; echo ',';echo $DProductionTL[12]['clinker']; echo ',';?>]
                }]
        });
    });
    $(function () {
