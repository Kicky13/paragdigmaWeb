...
for ($i = 1; $i <= 12; $i++) {
    ...
    if (empty($myDataPD["$thn-$my_month"])) {
        $myDataPD["$thn-$my_month"]['indarung2'] = 0;
        $myDataPD["$thn-$my_month"]['indarung3'] = 0;
        $myDataPD["$thn-$my_month"]['indarung4'] = 0;
        $myDataPD["$thn-$my_month"]['indarung5'] = 0;
        $myDataPD["$thn-$my_month"]['indarung6'] = 0;
        $myDataPD["$thn-$my_month"]['dumai'] = 0;
    }
}
...
<script>
    $(function () {
        $('#container').highcharts({
            ...
            colors: ['#96281B', '#97CE68', '#FEC606', '#FF7416', '#CF000F', '#3D8EB9', '#8085e9', '#f15c80', '#e4d354', '#8d4653', '#91e8e1', '#2c3e50'],
            credits: {
                enabled: false
            },
            exporting: {
            ...
            series: [
                {
                    ...
                    data: [<?php echo $myDataPD["$thn-01"]['indarung2'];
echo ',';
echo $myDataPD["$thn-02"]['indarung2'];
echo ',';
echo $myDataPD["$thn-03"]['indarung2'];
echo ',';
echo $myDataPD["$thn-04"]['indarung2'];
echo ',';
echo $myDataPD["$thn-05"]['indarung2'];
echo ',';
echo $myDataPD["$thn-06"]['indarung2'];
echo ',';
echo $myDataPD["$thn-07"]['indarung2'];
echo ',';
echo $myDataPD["$thn-08"]['indarung2'];
echo ',';
echo $myDataPD["$thn-09"]['indarung2'];
echo ',';
echo $myDataPD["$thn-10"]['indarung2'];
echo ',';
echo $myDataPD["$thn-11"]['indarung2'];
echo ',';
echo $myDataPD["$thn-12"]['indarung2'];?>]
                }, {
                    name: 'IND III',
                    type: 'column',
                    yAxis: 1,
...
echo ',';
echo $myDataPD["$thn-02"]['indarung3'];
echo ',';
echo $myDataPD["$thn-03"]['indarung3'];
echo ',';
echo $myDataPD["$thn-04"]['indarung3'];
echo ',';
echo $myDataPD["$thn-05"]['indarung3'];
echo ',';
echo $myDataPD["$thn-06"]['indarung3'];
echo ',';
echo $myDataPD["$thn-07"]['indarung3'];
echo ',';
echo $myDataPD["$thn-08"]['indarung3'];
echo ',';
echo $myDataPD["$thn-09"]['indarung3'];
echo ',';
echo $myDataPD["$thn-10"]['indarung3'];
echo ',';
echo $myDataPD["$thn-11"]['indarung3'];
echo ',';
echo $myDataPD["$thn-12"]['indarung3'];?>]
                }, {
                    name: 'IND IV',
                    type: 'column',
                    yAxis: 1,
                    ...
                    data: [<?php echo $myDataPD["$thn-01"]['indarung4'];
echo ',';
echo $myDataPD["$thn-02"]['indarung4'];
echo ',';
echo $myDataPD["$thn-03"]['indarung4'];
echo ',';
echo $myDataPD["$thn-04"]['indarung4'];
echo ',';
echo $myDataPD["$thn-05"]['indarung4'];
echo ',';
echo $myDataPD["$thn-06"]['indarung4'];
echo ',';
echo $myDataPD["$thn-07"]['indarung4'];
echo ',';
echo $myDataPD["$thn-08"]['indarung4'];
echo ',';
echo $myDataPD["$thn-09"]['indarung4'];
echo ',';
echo $myDataPD["$thn-10"]['indarung4'];
echo ',';
echo $myDataPD["$thn-11"]['indarung4'];
echo ',';
echo $myDataPD["$thn-12"]['indarung4'];?>]
                }, {
                    name: 'IND V',
                    type: 'column',
                    yAxis: 1,
                    ...
                    data: [<?php echo $myDataPD["$thn-01"]['indarung5'];
echo ',';
echo $myDataPD["$thn-02"]['indarung5'];
echo ',';
echo $myDataPD["$thn-03"]['indarung5'];
echo ',';
echo $myDataPD["$thn-04"]['indarung5'];
echo ',';
echo $myDataPD["$thn-05"]['indarung5'];
echo ',';
echo $myDataPD["$thn-06"]['indarung5'];
echo ',';
echo $myDataPD["$thn-07"]['indarung5'];
echo ',';
echo $myDataPD["$thn-08"]['indarung5'];
echo ',';
echo $myDataPD["$thn-09"]['indarung5']; 
echo ',';
echo $myDataPD["$thn-10"]['indarung5'];
echo ',';
echo $myDataPD["$thn-11"]['indarung5'];
echo ',';
echo $myDataPD["$thn-12"]['indarung5'];?>]
                }, {
                    name: 'IND VI',
                    type: 'column',
                    yAxis: 1,
                    ...
                    data: [<?php echo $myDataPD["$thn-01"]['indarung6'];
echo ',';
echo $myDataPD["$thn-02"]['indarung6'];
echo ',';
echo $myDataPD["$thn-03"]['indarung6'];
echo ',';
echo $myDataPD["$thn-04"]['indarung6'];
echo ',';
echo $myDataPD["$thn-05"]['indarung6'];
echo ',';
echo $myDataPD["$thn-06"]['indarung6'];
echo ',';
echo $myDataPD["$thn-07"]['indarung6'];
echo ',';
echo $myDataPD["$thn-08"]['indarung6'];
echo ',';
echo $myDataPD["$thn-09"]['indarung6']; 
echo ',';
echo $myDataPD["$thn-10"]['indarung6'];
echo ',';
echo $myDataPD["$thn-11"]['indarung6'];
echo ',';
echo $myDataPD["$thn-12"]['indarung6'];?>]
                }, {
                    name: 'DUMAI',
                    type: 'column',
                    yAxis: 1,
                    ...
                    data: [<?php echo $myDataPD["$thn-01"]['dumai'];
echo ',';
echo $myDataPD["$thn-02"]['dumai'];
echo ',';
echo $myDataPD["$thn-03"]['dumai'];
echo ',';
echo $myDataPD["$thn-04"]['dumai'];
echo ',';
echo $myDataPD["$thn-05"]['dumai'];
echo ',';
echo $myDataPD["$thn-06"]['dumai'];
echo ',';
echo $myDataPD["$thn-07"]['dumai'];
echo ',';
echo $myDataPD["$thn-08"]['dumai'];
echo ',';
echo $myDataPD["$thn-09"]['dumai'];
echo ',';
echo $myDataPD["$thn-10"]['dumai']; 
echo ',';
echo $myDataPD["$thn-11"]['dumai'];
echo ',';
echo $myDataPD["$thn-12"]['dumai']; ?>]
                }, {
                    name: '<b>RKAP</b>',
                    type: 'spline',
                    tooltip: {
                    ...
                    data: [<?php echo $DProductionPD[1]['cement'];
echo ',';
echo $DProductionPD[2]['cement'];
echo ',';
echo $DProductionPD[3]['cement'];
echo ',';
echo $DProductionPD[4]['cement'];
echo ',';
echo $DProductionPD[5]['cement'];
echo ',';
echo $DProductionPD[6]['cement'];
echo ',';
echo $DProductionPD[7]['cement'];
echo ',';
echo $DProductionPD[8]['cement'];
echo ',';
echo $DProductionPD[9]['cement'];
echo ',';
echo $DProductionPD[10]['cement'];
echo ',';
echo $DProductionPD[11]['cement'];
echo ',';
echo $DProductionPD[12]['cement']; ?>]
                }]
        });
    });
    $(function () {
