            ...
            series: [
                {
                    ...
                    data: [<?php echo $myData["$thn-01"]['fm1'];
echo ',';
echo $myData["$thn-02"]['fm1'];
echo ',';
echo $myData["$thn-03"]['fm1'];
echo ',';
echo $myData["$thn-04"]['fm1'];
echo ',';
echo $myData["$thn-05"]['fm1'];
echo ',';
echo $myData["$thn-06"]['fm1'];
echo ',';
echo $myData["$thn-07"]['fm1'];
echo ',';
echo $myData["$thn-08"]['fm1'];
echo ',';
echo $myData["$thn-09"]['fm1'];
echo ',';
echo $myData["$thn-10"]['fm1'];
echo ',';
echo $myData["$thn-11"]['fm1'];
echo ',';
echo $myData["$thn-12"]['fm1'];?>]
                },{
                    name: 'RKAP',
                    type: 'spline',
                    tooltip: {
