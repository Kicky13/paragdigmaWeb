            ...
            series: [
                {
                    ...
                    data: [<?php echo $myData["$thn-01"]['tuban1']; echo ',';echo $myData["$thn-02"]['tuban1']; echo ',';echo $myData["$thn-03"]['tuban1']; echo ',';echo $myData["$thn-04"]['tuban1']; echo ',';echo $myData["$thn-05"]['tuban1']; echo ',';echo $myData["$thn-06"]['tuban1']; echo ',';echo $myData["$thn-07"]['tuban1']; echo ',';echo $myData["$thn-08"]['tuban1']; echo ',';echo $myData["$thn-09"]['tuban1']; echo ',';?>]
                },{
                    name: 'TBN II',
                    type: 'column',
                    yAxis: 1,
                    ...
                    data: [<?php echo $myData["$thn-01"]['tuban2']; echo ',';echo $myData["$thn-02"]['tuban2']; echo ',';echo $myData["$thn-03"]['tuban2']; echo ',';echo $myData["$thn-04"]['tuban2']; echo ',';echo $myData["$thn-05"]['tuban2']; echo ',';echo $myData["$thn-06"]['tuban2']; echo ',';echo $myData["$thn-07"]['tuban2']; echo ',';echo $myData["$thn-08"]['tuban2']; echo ',';echo $myData["$thn-09"]['tuban2']; echo ',';?>]
                },{
                    name: 'TBN III',
                    type: 'column',
                    yAxis: 1,
                    ...
                    data: [<?php echo $myData["$thn-01"]['tuban3']; echo ',';echo $myData["$thn-02"]['tuban3']; echo ',';echo $myData["$thn-03"]['tuban3']; echo ',';echo $myData["$thn-04"]['tuban3']; echo ',';echo $myData["$thn-05"]['tuban3']; echo ',';echo $myData["$thn-06"]['tuban3']; echo ',';echo $myData["$thn-07"]['tuban3']; echo ',';echo $myData["$thn-08"]['tuban3']; echo ',';echo $myData["$thn-09"]['tuban3']; echo ',';?>]
                },{
                    name: 'TBN IV',
                    type: 'column',
                    yAxis: 1,
                    ...
                    data: [<?php echo $myData["$thn-01"]['tuban4']; echo ',';echo $myData["$thn-02"]['tuban4']; echo ',';echo $myData["$thn-03"]['tuban4']; echo ',';echo $myData["$thn-04"]['tuban4']; echo ',';echo $myData["$thn-05"]['tuban4']; echo ',';echo $myData["$thn-06"]['tuban4']; echo ',';echo $myData["$thn-07"]['tuban4']; echo ',';echo $myData["$thn-08"]['tuban4']; echo ',';echo $myData["$thn-09"]['tuban4']; echo ',';?>]
                },{
                    name: 'GRS',
                    type: 'column',
                    yAxis: 1,
                    ...
                    data: [<?php echo $myData["$thn-01"]['gresik']; echo ',';echo $myData["$thn-02"]['gresik']; echo ',';echo $myData["$thn-03"]['gresik']; echo ',';echo $myData["$thn-04"]['gresik']; echo ',';echo $myData["$thn-05"]['gresik']; echo ',';echo $myData["$thn-06"]['gresik']; echo ',';echo $myData["$thn-07"]['gresik']; echo ',';echo $myData["$thn-08"]['gresik']; echo ',';echo $myData["$thn-09"]['gresik']; echo ',';?>]
                },{
                    name: 'RKAP',
                    type: 'spline',
                    tooltip: {
                    ...
                    data: [<?php echo $DProduction[1]['cement']; echo ',';echo $DProduction[2]['cement']; echo ',';echo $DProduction[3]['cement']; echo ',';echo $DProduction[4]['cement']; echo ',';echo $DProduction[5]['cement']; echo ',';echo $DProduction[6]['cement']; echo ',';echo $DProduction[7]['cement']; echo ',';echo $DProduction[8]['cement']; echo ',';echo $DProduction[9]['cement']; echo ',';echo $DProduction[10]['cement']; echo ',';echo $DProduction[11]['cement']; echo ',';echo $DProduction[12]['cement']; echo ',';?>]
                }]
        });
    });
    $(function () {
