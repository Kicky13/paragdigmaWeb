    ...
    <nav class="navbar navbar-inverse my_margin">
        <div class="col-md-3 container-fluid">
            <div class="navbar-header">
                <h3 style="text-align: left; padding-left: 12px; margin-top: 10px; color: white">Clinker Chart's Y-Axis</h3>
            </div>
        </div>
        <div class="col-md-9">
            <div class="col-md-3">
            ...
            <div class="col-md-3 collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <form class="navbar-form navbar-left">
                    ...
                    <div class="btn-group">
                        <button class="btn btn-warning" aria-label="Left Align" id="btn_cement_chart" type="button">
                            Cement Chart
                        </button>
                        <button class="btn btn-default " aria-label="Left Align" id="btn_clinker_chart" type="button">
                            Clinker Chart
                        </button>
                    </div>
                </form>
...
//            cellProperties.className = "htCenter htMiddle";
        ...
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?= site_url() ?>/plant_administrator/save_chart_clinker/<?php echo $tahun; ?>',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'plant_administrator/load_chart_clinker?tahun=<?php echo $tahun; ?>',
            type: 'GET',
