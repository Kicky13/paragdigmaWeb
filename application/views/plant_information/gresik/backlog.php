    ...
    <nav class="navbar navbar-default panelup">
        <div class="container-fluid">
            <div class="col-xs-9 navbar-header">
                ...
                <h3 style="text-align: left; padding-left: 12px; margin-top: 10px;">Tuban Plant Backlog Report</h3>
            </div>
...
<!--<div class="col-xs-12">
    <div align="center">Tuban Plant Dashboard</div>
...
<div class="col-xs-12">
    ...
    <div class="col-xs-3">
        ...
        <div id="piechart2" style="min-height: 300px"></div>
        <div id="columnchart2" style="min-height: 300px"></div>
    </div>
    <div class="col-xs-3">
        <div align="center">Tuban #3</div>
        <div id="piechart3" style="min-height: 300px"></div>
        <div id="columnchart3" style="min-height: 300px"></div>
    </div>
    <div class="col-xs-3">
        <div align="center">Tuban #4</div>
        <div id="piechart4" style="min-height: 300px"></div>
        <div id="columnchart4" style="min-height: 300px"></div>
    </div>
</div>-->
<script>
    //Dashboard
    ...
    $.ajax({
        url: '<?php echo base_url()?>index.php/plant_gresik/backlog_data?company=7000&tahun=' + my_tahun,
        type: 'GET',
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('#piechart1').highcharts({
                ...
                subtitle: {
                    text: '(click on the chart for detail)'
                },
                credits: {
                    enabled: false
                },
