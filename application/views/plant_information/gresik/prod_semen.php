...
?>').addClass('active btn-danger');
    ...
    function Btn_Tahun(tahun) {
        var url = "<?= base_url() ?>index.php/plant_gresik/prod_semen";
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li role="separator" class="divider"></li>
                            <li class="active"><a href="<?= base_url() ?>index.php/plant_gresik/prod_semen">KSO SI-Sg</a></li>
                            <li role="separator" class="divider"></li>
...
<div class="row">
    <div class="col-xs-12  col-md-2 noPadding">
        <div class=" headsix cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                $total_upto_year_sg = (array_sum(($myData["$thn-01"]))) + (array_sum(($myData["$thn-02"]))) + (array_sum(($myData["$thn-03"]))) + (array_sum(($myData["$thn-04"]))) + (array_sum(($myData["$thn-05"]))) + (array_sum(($myData["$thn-06"]))) + (array_sum(($myData["$thn-07"]))) + (array_sum(($myData["$thn-08"]))) + (array_sum(($myData["$thn-09"]))) + (array_sum(($myData["$thn-10"]))) + (array_sum(($myData["$thn-11"]))) + (array_sum(($myData["$thn-12"])));
        ...
        <div class="headsix cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP :
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($myData["$thn-$my_month"]['tuban1'])) {
                        $myData["$thn-$my_month"]['tuban1'] = 0;
                        $myData["$thn-$my_month"]['tuban2'] = 0;
                        $myData["$thn-$my_month"]['tuban3'] = 0;
                        $myData["$thn-$my_month"]['tuban4'] = 0;
                ...
                if (empty($rkap_cement[$thn]['tuban1'])) {
                    $rkap_cement[$thn]['tuban1'] = 0;
                }
                $total_rkap_year_tb1 = $rkap_cement[$thn]['tuban1'];
                $total_upto_year_tb1 = (($myData["$thn-01"]['tuban1']) + ($myData["$thn-02"]['tuban1']) + ($myData["$thn-03"]['tuban1'])) + (($myData["$thn-04"]['tuban1']) + ($myData["$thn-05"]['tuban1']) + ($myData["$thn-06"]['tuban1'])) + (($myData["$thn-07"]['tuban1']) + ($myData["$thn-08"]['tuban1']) + ($myData["$thn-09"]['tuban1'])) + (($myData["$thn-10"]['tuban1']) + ($myData["$thn-11"]['tuban1']) + ($myData["$thn-12"]['tuban1']));
        ...
        <div class="headsix cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($myData["$thn-$my_month"]['tuban2'])) {
                        $myData["$thn-$my_month"]['tuban1'] = 0;
                        $myData["$thn-$my_month"]['tuban2'] = 0;
                        $myData["$thn-$my_month"]['tuban3'] = 0;
                        $myData["$thn-$my_month"]['tuban4'] = 0;
                ...
                if (empty($rkap_cement[$thn]['tuban2'])) {
                    $rkap_cement[$thn]['tuban2'] = 0;
                }
                $total_rkap_year_tb2 = $rkap_cement[$thn]['tuban2'];
                $total_upto_year_tb2 = (($myData["$thn-01"]['tuban2']) + ($myData["$thn-02"]['tuban2']) + ($myData["$thn-03"]['tuban2'])) + (($myData["$thn-04"]['tuban2']) + ($myData["$thn-05"]['tuban2']) + ($myData["$thn-06"]['tuban2'])) + (($myData["$thn-07"]['tuban2']) + ($myData["$thn-08"]['tuban2']) + ($myData["$thn-09"]['tuban2'])) + (($myData["$thn-10"]['tuban2']) + ($myData["$thn-11"]['tuban2']) + ($myData["$thn-12"]['tuban2']));
        ...
        <div class="headsix cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($myData["$thn-$my_month"]['tuban3'])) {
                        $myData["$thn-$my_month"]['tuban1'] = 0;
                        $myData["$thn-$my_month"]['tuban2'] = 0;
                        $myData["$thn-$my_month"]['tuban3'] = 0;
                        $myData["$thn-$my_month"]['tuban4'] = 0;
                ...
                if (empty($rkap_cement[$thn]['tuban3'])) {
                    $rkap_cement[$thn]['tuban3'] = 0;
                }
        ...
        <div class="headsix cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($myData["$thn-$my_month"]['tuban4'])) {
                        $myData["$thn-$my_month"]['tuban1'] = 0;
                        $myData["$thn-$my_month"]['tuban2'] = 0;
                        $myData["$thn-$my_month"]['tuban3'] = 0;
                        $myData["$thn-$my_month"]['tuban4'] = 0;
                ...
                if (empty($rkap_cement[$thn]['tuban4'])) {
                    $rkap_cement[$thn]['tuban4'] = 0;
                }
    ...
    <div class="col-xs-12  col-md-2 noPadding">
        <div class="headsix cubesRun" > 
            <div class="col-xs-2 noPadding"  style="font-weight: bold;">GRS</div>
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                <?php
                for ($i = 1; $i <= 12; $i++) {
                    if (strlen($i) < 2) {
                    ...
                    if (empty($myData["$thn-$my_month"]['gresik'])) {
                        $myData["$thn-$my_month"]['tuban1'] = 0;
                        $myData["$thn-$my_month"]['tuban2'] = 0;
                        $myData["$thn-$my_month"]['tuban3'] = 0;
                        $myData["$thn-$my_month"]['tuban4'] = 0;
                ...
                if (empty($rkap_cement[$thn]['gresik'])) {
                    $rkap_cement[$thn]['gresik'] = 0;
                }
                ...
                echo number_format($total_rkap_year_grs)
                ?> T</div>
            <?php
            $hasil_year_grs = @($total_upto_year_grs / $total_rkap_year_grs) * 100;
            if ($hasil_year_grs < 100) {
                echo '<div class="col-xs-12 noPadding" align="center" style="color: #f00"><h4>' . number_format($hasil_year_grs, 2, ",", ".") . '%</h4></div>';
            } else {
                echo '<div class="col-xs-12 noPadding" align="center" style="color: #6bbb3e"><h4>' . number_format($hasil_year_grs, 2, ",", ".") . '%</h4></div>';
            }
            ?>
            Real : 
            <span class="row-xs-2 noPadding" align="left"  style="font-weight: bold;"><?php echo number_format($total_upto_year_grs) ?> T</span>
        </div>
    </div>
</div>
<div class="row">
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($myData["$thn-01"]) || !empty($myData["$thn-02"]) || !empty($myData["$thn-03"])) {
                            $tot_tb1 = (($myData["$thn-01"]['tuban1']) + ($myData["$thn-02"]['tuban1']) + ($myData["$thn-03"]['tuban1']));
                            $tot_tb2 = (($myData["$thn-01"]['tuban2']) + ($myData["$thn-02"]['tuban2']) + ($myData["$thn-03"]['tuban2']));
                            $tot_tb3 = (($myData["$thn-01"]['tuban3']) + ($myData["$thn-02"]['tuban3']) + ($myData["$thn-03"]['tuban3']));
                            $tot_tb4 = (($myData["$thn-01"]['tuban4']) + ($myData["$thn-02"]['tuban4']) + ($myData["$thn-03"]['tuban4']));
                            $tot_sg = (($myData["$thn-01"]['gresik']) + ($myData["$thn-02"]['gresik']) + ($myData["$thn-03"]['gresik']));
                            ...
                            echo '<div class="col-xs-2 noPadding" align="center" style="font-weight: bold; font-style: italic;">SG</div>';
                            echo '<div class="col-xs-10 noPadding" align="right">' . number_format($tot_sg, 0, ",", ".") . ' T</div>';
                        } else {
                            echo '<div class="col-xs-2 noPadding" align="center" style="font-weight: bold; font-style: italic;">I</div>';
                            echo '<div class="col-xs-10 noPadding" align="right">' . number_format(0, 2, ",", ".") . ' T</div>';
                            echo '<div class="col-xs-2 noPadding" align="center" style="font-weight: bold; font-style: italic;">II</div>';
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($myData["$thn-04"]) || !empty($myData["$thn-05"]) || !empty($myData["$thn-06"])) {
                            $tot_tb1 = (($myData["$thn-04"]['tuban1']) + ($myData["$thn-05"]['tuban1']) + ($myData["$thn-06"]['tuban1']));
                            $tot_tb2 = (($myData["$thn-04"]['tuban2']) + ($myData["$thn-05"]['tuban2']) + ($myData["$thn-06"]['tuban2']));
                            $tot_tb3 = (($myData["$thn-04"]['tuban3']) + ($myData["$thn-05"]['tuban3']) + ($myData["$thn-06"]['tuban3']));
                            $tot_tb4 = (($myData["$thn-04"]['tuban4']) + ($myData["$thn-05"]['tuban4']) + ($myData["$thn-06"]['tuban4']));
                            $tot_sg = (($myData["$thn-04"]['gresik']) + ($myData["$thn-05"]['gresik']) + ($myData["$thn-06"]['gresik']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($myData["$thn-07"]) || !empty($myData["$thn-08"]) || !empty($myData["$thn-09"])) {
                            $tot_tb1 = (($myData["$thn-07"]['tuban1']) + ($myData["$thn-08"]['tuban1']) + ($myData["$thn-09"]['tuban1']));
                            $tot_tb2 = (($myData["$thn-07"]['tuban2']) + ($myData["$thn-08"]['tuban2']) + ($myData["$thn-09"]['tuban2']));
                            $tot_tb3 = (($myData["$thn-07"]['tuban3']) + ($myData["$thn-08"]['tuban3']) + ($myData["$thn-09"]['tuban3']));
                            $tot_tb4 = (($myData["$thn-07"]['tuban4']) + ($myData["$thn-08"]['tuban4']) + ($myData["$thn-09"]['tuban4']));
                            $tot_sg = (($myData["$thn-07"]['gresik']) + ($myData["$thn-08"]['gresik']) + ($myData["$thn-09"]['gresik']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($myData["$thn-10"]) || !empty($myData["$thn-11"]) || !empty($myData["$thn-12"])) {
                            $tot_tb1 = (($myData["$thn-10"]['tuban1']) + ($myData["$thn-11"]['tuban1']) + ($myData["$thn-12"]['tuban1']));
                            $tot_tb2 = (($myData["$thn-10"]['tuban2']) + ($myData["$thn-11"]['tuban2']) + ($myData["$thn-12"]['tuban2']));
                            $tot_tb3 = (($myData["$thn-10"]['tuban3']) + ($myData["$thn-11"]['tuban3']) + ($myData["$thn-12"]['tuban3']));
                            $tot_tb4 = (($myData["$thn-10"]['tuban4']) + ($myData["$thn-11"]['tuban4']) + ($myData["$thn-12"]['tuban4']));
                            $tot_sg = (($myData["$thn-10"]['gresik']) + ($myData["$thn-11"]['gresik']) + ($myData["$thn-12"]['gresik']));
