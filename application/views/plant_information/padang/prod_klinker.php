...
<script>
    ...
    function selectThn() {
        var thn = $('#tahun').val();
        window.location.href = 'index.php/plant_padang/prod_semen?tahun=' + thn;
    }
...
?>').addClass('active btn-danger');
    ...
    function Btn_Tahun(tahun) {
        var url = "<?= base_url() ?>index.php/plant_padang/klin_semen";
...
//                            echo 'Last Update on : ' . date_format($tanggal, "d F Y");
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="<?= base_url() ?>index.php/plant_padang/klin_semen">Padang</a></li>
                            <li role="separator" class="divider"></li>
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($klinData["$thn-$my_month"])) {
                        $klinData["$thn-$my_month"]['indarung2'] = 0;
                        $klinData["$thn-$my_month"]['indarung3'] = 0;
                        $klinData["$thn-$my_month"]['indarung4'] = 0;
                        $klinData["$thn-$my_month"]['indarung5'] = 0;
                    }
                }
        ...
        <div class="headside cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP :
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($klinData["$thn-$my_month"]['indarung2'])) {
                        $klinData["$thn-$my_month"]['indarung2'] = 0;
                        $klinData["$thn-$my_month"]['indarung3'] = 0;
                        $klinData["$thn-$my_month"]['indarung4'] = 0;
                        $klinData["$thn-$my_month"]['indarung5'] = 0;
                ...
                if (empty($rkap_klin[$thn]['indarung2'])) {
                    $rkap_klin[$thn]['indarung2'] = 0;
                }
                $total_rkap_year_tb1 = $rkap_klin[$thn]['indarung2'];
                $total_upto_year_tb1 = (($klinData["$thn-01"]['indarung2']) + ($klinData["$thn-02"]['indarung2']) + ($klinData["$thn-03"]['indarung2'])) + (($klinData["$thn-04"]['indarung2']) + ($klinData["$thn-05"]['indarung2']) + ($klinData["$thn-06"]['indarung2'])) + (($klinData["$thn-07"]['indarung2']) + ($klinData["$thn-08"]['indarung2']) + ($klinData["$thn-09"]['indarung2'])) + (($klinData["$thn-10"]['indarung2']) + ($klinData["$thn-11"]['indarung2']) + ($klinData["$thn-12"]['indarung2']));
        ...
        <div class="headside cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($klinData["$thn-$my_month"]['indarung3'])) {
                        $klinData["$thn-$my_month"]['indarung2'] = 0;
                        $klinData["$thn-$my_month"]['indarung3'] = 0;
                        $klinData["$thn-$my_month"]['indarung4'] = 0;
                        $klinData["$thn-$my_month"]['indarung5'] = 0;
                ...
                if (empty($rkap_klin[$thn]['indarung3'])) {
                    $rkap_klin[$thn]['indarung3'] = 0;
                }
                $total_rkap_year_tb2 = $rkap_klin[$thn]['indarung3'];
                $total_upto_year_tb2 = (($klinData["$thn-01"]['indarung3']) + ($klinData["$thn-02"]['indarung3']) + ($klinData["$thn-03"]['indarung3'])) + (($klinData["$thn-04"]['indarung3']) + ($klinData["$thn-05"]['indarung3']) + ($klinData["$thn-06"]['indarung3'])) + (($klinData["$thn-07"]['indarung3']) + ($klinData["$thn-08"]['indarung3']) + ($klinData["$thn-09"]['indarung3'])) + (($klinData["$thn-10"]['indarung3']) + ($klinData["$thn-11"]['indarung3']) + ($klinData["$thn-12"]['indarung3']));
        ...
        <div class="headside cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($klinData["$thn-$my_month"]['indarung4'])) {
                        $klinData["$thn-$my_month"]['indarung2'] = 0;
                        $klinData["$thn-$my_month"]['indarung3'] = 0;
                        $klinData["$thn-$my_month"]['indarung4'] = 0;
                        $klinData["$thn-$my_month"]['indarung5'] = 0;
                ...
                if (empty($rkap_klin[$thn]['indarung4'])) {
                    $rkap_klin[$thn]['indarung4'] = 0;
                }
                $total_rkap_year_tb3 = $rkap_klin[$thn]['indarung4'];
                $total_upto_year_tb3 = (($klinData["$thn-01"]['indarung4']) + ($klinData["$thn-02"]['indarung4']) + ($klinData["$thn-03"]['indarung4'])) + (($klinData["$thn-04"]['indarung4']) + ($klinData["$thn-05"]['indarung4']) + ($klinData["$thn-06"]['indarung4'])) + (($klinData["$thn-07"]['indarung4']) + ($klinData["$thn-08"]['indarung4']) + ($klinData["$thn-09"]['indarung4'])) + (($klinData["$thn-10"]['indarung4']) + ($klinData["$thn-11"]['indarung4']) + ($klinData["$thn-12"]['indarung4']));
        ...
        <div class="headside cubesRun" > 
            ...
            <div class="col-xs-10 noPadding" align="right">RKAP : 
                ...
                for ($i = 1; $i <= 12; $i++) {
                    ...
                    if (empty($klinData["$thn-$my_month"]['indarung5'])) {
                        $klinData["$thn-$my_month"]['indarung2'] = 0;
                        $klinData["$thn-$my_month"]['indarung3'] = 0;
                        $klinData["$thn-$my_month"]['indarung4'] = 0;
                        $klinData["$thn-$my_month"]['indarung5'] = 0;
                ...
                if (empty($rkap_klin[$thn]['indarung5'])) {
                    $rkap_klin[$thn]['indarung5'] = 0;
                }
                $total_rkap_year_tb4 = $rkap_klin[$thn]['indarung5'];
                $total_upto_year_tb4 = (($klinData["$thn-01"]['indarung5']) + ($klinData["$thn-02"]['indarung5']) + ($klinData["$thn-03"]['indarung5'])) + (($klinData["$thn-04"]['indarung5']) + ($klinData["$thn-05"]['indarung5']) + ($klinData["$thn-06"]['indarung5'])) + (($klinData["$thn-07"]['indarung5']) + ($klinData["$thn-08"]['indarung5']) + ($klinData["$thn-09"]['indarung5'])) + (($klinData["$thn-10"]['indarung4']) + ($klinData["$thn-11"]['indarung4']) + ($klinData["$thn-12"]['indarung4']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($klinData["$thn-01"]) || !empty($klinData["$thn-02"]) || !empty($klinData["$thn-03"])) {
                            $tot_ind2 = (($klinData["$thn-01"]['indarung2']) + ($klinData["$thn-02"]['indarung2']) + ($klinData["$thn-03"]['indarung2']));
                            $tot_ind3 = (($klinData["$thn-01"]['indarung3']) + ($klinData["$thn-02"]['indarung3']) + ($klinData["$thn-03"]['indarung3']));
                            $tot_ind4 = (($klinData["$thn-01"]['indarung4']) + ($klinData["$thn-02"]['indarung4']) + ($klinData["$thn-03"]['indarung4']));
                            $tot_ind5 = (($klinData["$thn-01"]['indarung5']) + ($klinData["$thn-02"]['indarung5']) + ($klinData["$thn-03"]['indarung5']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($klinData["$thn-04"]) || !empty($klinData["$thn-05"]) || !empty($klinData["$thn-06"])) {
                            $tot_ind2 = (($klinData["$thn-04"]['indarung2']) + ($klinData["$thn-05"]['indarung2']) + ($klinData["$thn-06"]['indarung2']));
                            $tot_ind3 = (($klinData["$thn-04"]['indarung3']) + ($klinData["$thn-05"]['indarung3']) + ($klinData["$thn-06"]['indarung3']));
                            $tot_ind4 = (($klinData["$thn-04"]['indarung4']) + ($klinData["$thn-05"]['indarung4']) + ($klinData["$thn-06"]['indarung4']));
                            $tot_ind5 = (($klinData["$thn-04"]['indarung5']) + ($klinData["$thn-05"]['indarung5']) + ($klinData["$thn-06"]['indarung5']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($klinData["$thn-07"]) || !empty($klinData["$thn-08"]) || !empty($klinData["$thn-09"])) {
                            $tot_ind2 = (($klinData["$thn-07"]['indarung2']) + ($klinData["$thn-08"]['indarung2']) + ($klinData["$thn-09"]['indarung2']));
                            $tot_ind3 = (($klinData["$thn-07"]['indarung3']) + ($klinData["$thn-08"]['indarung3']) + ($klinData["$thn-09"]['indarung3']));
                            $tot_ind4 = (($klinData["$thn-07"]['indarung4']) + ($klinData["$thn-08"]['indarung4']) + ($klinData["$thn-09"]['indarung4']));
                            $tot_ind5 = (($klinData["$thn-07"]['indarung5']) + ($klinData["$thn-08"]['indarung5']) + ($klinData["$thn-09"]['indarung5']));
            ...
            <div class="col-xs-12 col-md-3 noPadding" >
                <div class="headmenu cubesRun2">
                    ...
                    <div class="col-xs-5 noPadding" align="right">
                        <?php
                        if (!empty($klinData["$thn-10"]) || !empty($klinData["$thn-11"]) || !empty($klinData["$thn-12"])) {
                            $tot_ind2 = (($klinData["$thn-10"]['indarung2']) + ($klinData["$thn-11"]['indarung2']) + ($klinData["$thn-12"]['indarung2']));
                            $tot_ind3 = (($klinData["$thn-10"]['indarung3']) + ($klinData["$thn-11"]['indarung3']) + ($klinData["$thn-12"]['indarung3']));
                            $tot_ind4 = (($klinData["$thn-10"]['indarung4']) + ($klinData["$thn-11"]['indarung4']) + ($klinData["$thn-12"]['indarung4']));
                            $tot_ind5 = (($klinData["$thn-10"]['indarung5']) + ($klinData["$thn-11"]['indarung5']) + ($klinData["$thn-12"]['indarung5']));
