                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active"><a href="<?= base_url() ?>index.php/plant_padang/analysis">Padang</a></li>
                            <li role="separator" class="divider"></li>

                            <li><a href="<?= base_url() ?>index.php/plant_gresik/analysis">Gresik</a></li>
                            <li role="separator" class="divider"></li>
...
<div class="row">
    <h1 style="padding-left: 20px;">Padang Plant Analysis Page</h1>
