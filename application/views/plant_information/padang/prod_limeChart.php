...
<div class="row">
	<div class="col-xs-3">
		<h4>Chart Lime Stone Production</h4>
	</div>
	<div class="col-xs-6">
		<div class="btn-group">
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Realisasi Pencapaian Produksi Lime Stone'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
			<?php 
						echo $DProduction[1]['lime'];
						for($i=2;$i <= 12 ; $i++){
							echo ",".$DProduction[$i]['lime'];
							}
					?>
            ...
            data: [
					<?php 
						echo $DProduction[1]['limeReal'];
						for($i=2;$i <= date('n') ; $i++){
							echo ",".$DProduction[$i]['limeReal'];
							}
					?>
			],
            tooltip: {
