...
<div class="row">
	...
	<div class="col-xs-6">
		<div class="btn-group">
			...
			<button class="btn btn-default active" aria-label="Left Align" id="btn_prod_semen" type="button">
				Cement 
			</button>
		</div>
	</div>
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'Realisasi Pencapaian Produksi Cement'
        },
        subtitle: {
        ...
        series: [{
            ...
            data: [
					<?php 
						echo $DProduction[1]['cement'];
						for($i=2;$i <= 12 ; $i++){
							echo ",".$DProduction[$i]['cement'];
							}
					?>
			],
            tooltip: {
