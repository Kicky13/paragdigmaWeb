            ...
            <nav class="navbar navbar-default panelup">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header ">
                        ...
                        <h3 style="text-align: left; padding-left: 12px; margin-top: 10px;">Tonasa Plant Data Historian</h3>
                    </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="<?= base_url() ?>index.php/plant_historian/st_hist">Tonasa</a></li>
                                    <li role="separator" class="divider"></li>
