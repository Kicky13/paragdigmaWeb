                ...
                <ul class="nav navbar-nav navbar-center">
                    <li class="dropdown">
                        ...
                        $jenis_arr = array(1 => "FINISH MILL II", 2 => "FINISH MILL III", 3 => "FINISH MILL IVa",
                            4 => "FINISH MILL IVb", 5 => "FINISH MILL Va", 6 => "FINISH MILL Vb", 8 => "FINISH MILL VI", 7 => "FINISH MILL FMDM");
                        ?>
                    ...
                    point: {
                        events: {
                            click: function() {
                                ...
                                if (plant != null) {
                                    var myUrl = 'eksekutif_report/get_fm_operation?tanggal=' + tgl + '&bulan=' + bulan + '&tahun=' + tahun + '&plant=' + plant + '&company=3000';
                                } else {
                                    var myUrl = 'eksekutif_report/get_fm_operation?tanggal=' + tgl + '&bulan=' + bulan + '&tahun=' + tahun + '&plant=ind2&company=3000';
                                }
                                $.ajax({
                                    url: myUrl,
                                    type: 'GET',
