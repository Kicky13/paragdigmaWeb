...
<script>
    $(function () {
        $('#btn_prod_semen').click(function () {
            window.location.href = 'index.php/eksekutif_report/eksekutif_report_cement/2';
        });
        $('#btn_prod_klin').click(function () {
            window.location.href = 'index.php/eksekutif_report/eksekutif_report_terak/2';
        });
        ...
        <div class="container-fluid">
            ...
            <div style="padding-left: 750px">
                <ul class="nav navbar-nav navbar-center">
                    <li class="dropdown">
                        <?php 
                        $jenis_arr = array(1 =>"KILN II",2 =>"KILN III",3 =>"KILN IV",4 =>"KILN V",5 =>"KILN VI");
                        ?>
                    ...
                    point: {
                        events: {
                            click: function() {
                                ...
                                var plant2 = <?php echo "'".$bantu."'" ?>;
                                if (plant2 != null) {
                                    var x ='eksekutif_report/get_kiln_operation?tanggal=' + tgl + '&bulan=' + bulan + '&tahun=' + tahun + '&plant=' + plant2 + '&company=3000';
                                }else{
                                    var x ='eksekutif_report/get_kiln_operation?tanggal=' + tgl + '&bulan=' + bulan + '&tahun=' + tahun + '&plant=ind2&company=3000';
                                }
                                console.log(tgl + "/" + bulan + "/" + tahun + ":" + plant2);
                                $.ajax({
                                    url:x,
                                    type: 'GET',
...
?>" />' +
    ...
    function Btn_periode(periode) {
        var url = "<?= base_url() ?>index.php/eksekutif_report/eksekutif_report_terak/2";
//        var url = "";
        var form = $('<form action="' + url + '" method="get">' +
