...
<script>
    $(function () {
        $('#btn_prod_semen').click(function () {
            window.location.href = 'index.php/eksekutif_report/eksekutif_report_cement/4';
        });
        $('#btn_prod_klin').click(function () {
            window.location.href = 'index.php/eksekutif_report/eksekutif_report_terak/4';
        });
        ...
        <div class="container-fluid">
            ...
            <div style="padding-left: 750px">
                <ul class="nav navbar-nav navbar-center">
                    <li class="dropdown">
                        <?php
                        $jenis_arr = array(1 => "FINISH MILL II", 2 => "FINISH MILL III", 3 => "FINISH MILL IVA",
                            4 => "FINISH MILL IVB", 5 => "FINISH MILL VA", 6 => "FINISH MILL VB");
                        ?>
                    ...
                    point: {
                        events: {
                            click: function() {
                                ...
                                if (plant != null) {
                                    var myUrl = 'eksekutif_report/get_fm_operation?tanggal=' + tgl + '&bulan=' + bulan + '&tahun=' + tahun + '&plant=' + plant + '&company=4000';
                                } else {
                                    var myUrl = 'eksekutif_report/get_fm_operation?tanggal=' + tgl + '&bulan=' + bulan + '&tahun=' + tahun + '&plant=mp&company=4000';
                                }
                                $.ajax({
                                    url: myUrl,
                                    type: 'GET',
...
?>" />' +
    ...
    function Btn_periode(periode) {
        var url = "<?= base_url() ?>index.php/eksekutif_report/eksekutif_report_cement/4";
//        var url = "";
        var form = $('<form action="' + url + '" method="get">' +
