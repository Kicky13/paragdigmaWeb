        ...
        <div class="container-fluid">
            ...
            <div style="padding-left: 750px">
                <ul class="nav navbar-nav navbar-center">
                    <li class="dropdown">
                        <?php
                        $jenis_arr = array(1 => "FINISH MILL #1", 2 => "FINISH MILL #2");
                        ?>
...
//                            interval ada di sisi sebelah kanan layar
            ...
            series: [{
                    ...
                    data: [
<?php
if (!empty($ton_riil[1]['TON_REAL'])) {
    echo $ton_riil[1]['TON_REAL'];
    for ($i = 2; $i <= count($ton_riil); $i++) {
        echo "," . $ton_riil[$i]['TON_REAL'];
    }
} else {
    echo 0;
}
