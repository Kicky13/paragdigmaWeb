                    ...
                    point: {
                        events: {
                            click: function() {
                                ...
                                if (plant != null) {
                                    var myUrl = 'eksekutif_report/get_fm_operation?tanggal=' + tgl + '&bulan=' + bulan + '&tahun=' + tahun + '&plant=' + plant + '&company=7000';
                                } else {
                                    var myUrl = 'eksekutif_report/get_fm_operation?tanggal=' + tgl + '&bulan=' + bulan + '&tahun=' + tahun + '&plant=tbn2&company=7000';
                                }
                                $.ajax({
                                    url: myUrl,
                                    type: 'GET',
