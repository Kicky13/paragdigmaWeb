...
/////////######################===UNTUK SETTING WAKTU BULAN DAN TAHUN====#########################
...
<script>
    $(function () {
        $('#btn_prod_semen').click(function () {
            window.location.href = 'index.php/eksekutif_report/eksekutif_report_cement/3';
        });
        $('#btn_prod_klin').click(function () {
            window.location.href = 'index.php/eksekutif_report/eksekutif_report_terak/3';
        });
        ...
        <div class="container-fluid">
            ...
            <div style="padding-left: 750px">
                <ul class="nav navbar-nav navbar-center">
                    <li class="dropdown">
                        <?php 
                        $jenis_arr = array(1 =>"KILN I",2 =>"KILN II",3 =>"KILN III",4 =>"KILN IV");
                        ?>
                    ...
                    point: {
                        events: {
                            click: function() {
                                ...
                                if (plant2 != null) {
                                    var x ='eksekutif_report/get_kiln_operation?tanggal=' + tgl + '&bulan=' + bulan + '&tahun=' + tahun + '&plant=' + plant2 + '&company=7000';
                                }else{
                                    var x ='eksekutif_report/get_kiln_operation?tanggal=' + tgl + '&bulan=' + bulan + '&tahun=' + tahun + '&plant=ind2&company=7000';
                                }
