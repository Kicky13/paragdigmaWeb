        ...
        <div class="container-fluid">
            ...
            <div style="padding-left: 750px">
                <ul class="nav navbar-nav navbar-center">
                    <li class="dropdown">
                        <?php
                        $jenis_arr = array(1 => "KILN II", 2 => "KILN III", 3 => "KILN IV", 4 => "KILN V");
                        ?>
                    ...
                    point: {
                        events: {
                            click: function () {
                                ...
                                if (plant2 != null) {
                                    var x = 'eksekutif_report/get_kiln_operation?tanggal=' + tgl + '&bulan=' + bulan + '&tahun=' + tahun + '&plant=' + plant2 + '&company=4000';
                                } else {
                                    var x = 'eksekutif_report/get_kiln_operation?tanggal=' + tgl + '&bulan=' + bulan + '&tahun=' + tahun + '&plant=ind2&company=4000';
                                }
...
?>" />' +
    ...
    function Btn_periode(periode) {
        var url = "<?= base_url() ?>index.php/eksekutif_report/eksekutif_report_terak/4";
        //        var url = "";
        var form = $('<form action="' + url + '" method="get">' +
