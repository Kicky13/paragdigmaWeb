        ...
        <form name="load" id="load" style="width: 100%;">
            <div class="col-md-4 container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="javascript:void(0)">Padang : KILN Operations Report</a>
                </div>
            </div>
            <div class="col-md-7"> <!--   container-fluid -->
                <div class="col-md-4" style="padding-left: 0px">
                    <ul class="nav navbar-nav navbar-center">
                        <li class="dropdown">
                            <?php
                            $jenis_arr = array(1 => "KILN Ind II", 2 => "KILN Ind III", 3 => "KILN Ind IV", 4 => "KILN Ind V");
                            ?>
...
<script>
    ...
    hot = new Handsontable($container[0], {
        ...
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?= site_url() ?>/master_data/save_kiln_sp/<?php echo $bulan; ?>/<?php echo $tahun; ?>/<?php echo $plant; ?>',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_kiln_sp/<?php echo $bulan; ?>/<?php echo $tahun; ?>/<?php echo $plant; ?>',
            type: 'GET',
