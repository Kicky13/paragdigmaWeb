            ...
            <form name="load" id="load" style="width: 100%;">
                <div class="col-md-4" style="padding-left: 0px">
                    <ul class="nav navbar-nav navbar-center">
                        <li class="dropdown">
                            <?php
                            $jenis_arr = array(1 => "Tonasa 2", 2 => "Tonasa 3", 3 => "Tonasa 4.2", 4 => "Tonasa 4.2", 5 => "Tonasa 5.1", 6 => "Tonasa 5.2");
                            ?>
...
columnSorting: true,
        ...
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?=site_url()?>/master_data/save_capacity_st',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_capacity_st/<?php echo $pemisah; ?>/<?php echo $plant; ?>/<?php echo $tahun; ?>',
            type: 'GET',
