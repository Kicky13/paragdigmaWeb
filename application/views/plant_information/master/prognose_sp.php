            ...
            <form name="load" id="load" style="width: 100%;">
                <div class="col-md-4" style="margin-top: 8px;">
                    <select class="form-control" name="plant" id="plant">
                        <option value="1">Indarung 2</option>
                        <option value="2">Indarung 3</option>
                        <option value="3">Indarung 4.1</option>
                        <option value="4">Indarung 4.2</option>
                        <option value="5">Indarung 5.1</option>
                        <option value="6">Indarung 5.2</option>
...
<script>
    ...
    hot = new Handsontable($container[0], {
        ...
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?= site_url() ?>/master_data/save_prognose_sp',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_prognose_sp/<?php echo $pemisah; ?>/<?php echo $bantu; ?>/<?php echo $bantu2; ?>',
            type: 'GET',
            success: function (res) {
                ...
                $console.html('Data loaded in plant <?php echo '<b>' . $plant . '</b>';
