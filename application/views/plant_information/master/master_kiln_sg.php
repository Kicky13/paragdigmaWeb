        ...
        <form name="load" id="load" style="width: 100%;">
            <div class="col-md-4 container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="javascript:void(0)">Gresik : KILN Operations Report</a>
                </div>
            </div>
            <div class="col-md-7"> <!--   container-fluid -->
                <div class="col-md-4" style="padding-left: 0px">
                    <ul class="nav navbar-nav navbar-center">
                        <li class="dropdown">
                            <?php
                            $jenis_arr = array(1 => "KILN Tb I", 2 => "KILN Tb II", 3 => "KILN Tb III", 4 => "KILN Tb IV");
                            ?>
...
<script>
    ...
    hot = new Handsontable($container[0], {
        ...
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?= site_url() ?>/master_data/save_kiln_sg/<?php echo $bulan; ?>/<?php echo $tahun; ?>/<?php echo $plant; ?>',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_kiln_sg/<?php echo $bulan; ?>/<?php echo $tahun; ?>/<?php echo $plant; ?>',
            type: 'GET',
