...
<script>
    ...
    hot = new Handsontable($container[0], {
        ...
        data: [
            ['DATE', 'KL1', 'KL2', 'KL3', 'KL4', 'FM1', 'FM2', 'FM3', 'FM4', 'FM5', 'FM6', 'FM7', 'FM8', 'FM9', 'FMA', 'FMB', 'FMC']
        ],
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?= site_url() ?>/master_data/save_prognose_day_sg/<?php echo $bulan; ?>/<?php echo $tahun; ?>',
                dataType: 'json',
                type: 'POST',
                data: {changes: change, tgl: hot.getDataAtCell(change[0][0], 0), bulan: <?php echo $bulan; ?>, tahun: <?php echo $tahun; ?>},
                success: function () {
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_prognose_day_sg/<?php echo $bulan; ?>/<?php echo $tahun; ?>',
            type: 'GET',
            success: function (res) {
                var mine = JSON.parse(res);
                var data = [], row;
                data[0] = ['DATE', 'KL1', 'KL2', 'KL3', 'KL4', 'FM1', 'FM2', 'FM3', 'FM4', 'FM5', 'FM6', 'FM7', 'FM8', 'FM9', 'FMA', 'FMB', 'FMC'];
    ...
    $("#save").click(function () {
        $.ajax({
            url: '<?= site_url() ?>/master_data/save_prognose_day_sg/<?php echo $bulan; ?>/<?php echo $tahun; ?>',
            data: {data: hot.getData(), bulan: <?php echo $bulan; ?>, tahun: <?php echo $tahun; ?>}, // returns all cells' data
            dataType: 'json',
            type: 'POST',
            success: function (res) {
                if (res.result === 'ok') {
    ...
    function Btn_periode(periode) {
        var url = "<?= base_url() ?>index.php/master_data/prognose_opco/2";
