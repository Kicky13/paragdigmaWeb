            ...
            <form name="load" id="load" style="width: 100%;">
                <div class="col-md-4" style="padding-left: 0px">
                    <ul class="nav navbar-nav navbar-center">
                        <li class="dropdown">
                            <?php
                            $jenis_arr = array(1 => "Indarung 2", 2 => "Indarung 3", 3 => "Indarung 4.2", 4 => "Indarung 4.2", 5 => "Indarung 5.1", 6 => "Indarung 5.2", 7 => "Dumai");
                            ?>
...
columnSorting: true,
        ...
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?=site_url()?>/master_data/save_capacity_sp',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_capacity_sp/<?php echo $pemisah; ?>/<?php echo $plant; ?>/<?php echo $tahun; ?>',
            type: 'GET',
