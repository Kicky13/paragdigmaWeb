            ...
            <form name="load" id="load" style="width: 100%;">
                <div class="col-md-4" style="margin-top: 8px;">
                    <select class="form-control" name="plant" id="plant">
                        <option value="1">Tuban 1/ FM 1</option>
                        <option value="2">Tuban 2/ FM 2</option>
                        <option value="3">Tuban 3/ FM 3</option>
                        <option value="4">Tuban 4/ FM 4</option>
                        <option value="5">FM 5</option>
                        <option value="6">FM 6</option>
                        <option value="7">FM 7</option>
                        <option value="8">FM 8</option>
                        <option value="9">FM 9</option>
                        <option value="10">FM A</option>
                        <option value="11">FM B</option>
                        <option value="12">FM C</option>
                    </select>
                </div>
                <div class="col-md-4" style="margin-top: 8px;">
                ...
                if ($bantu == 1) {
                    $plant = 'Tuban / Finish Mill 1';
                } else if ($bantu == 2) {
                    $plant = 'Tuban / Finish Mill 2';
                } else if ($bantu == 3) {
                    $plant = 'Tuban / Finish Mill 3';
                } else if ($bantu == 4) {
                    $plant = 'Tuban / Finish Mill 4';
                } else if ($bantu == 5) {
                    $plant = 'Finish Mill 5';
                } else if ($bantu == 6) {
                    $plant = 'Finish Mill 6';
...
<script>
    ...
    hot = new Handsontable($container[0], {
        ...
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?=site_url()?>/master_data/save_prognose_sg',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_prognose_sg/<?php echo $pemisah; ?>/<?php echo $bantu; ?>/<?php echo $bantu2; ?>',
            type: 'GET',
            success: function (res) {
                ...
                $console.html('Data loaded in plant <?php echo '<b>'.$plant.'</b>'; echo ' and year <b>'.$bantu2.'</b>';?>');
                hot.loadData(data);
            }
        });
    }).click();
