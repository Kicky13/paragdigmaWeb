<div class="col-md-12 col-xs-12 col-lg-12" style="padding: 0px; height: 250px">
    <div class="col-md-12 col-xs-12" style="height:29px; margin-bottom:34px;padding: 0px;">
        <div class="small-box " style="background-image: url(media/full-pattern.png); background-size: 40%; background-repeat: repeat-y; background-color: #f9f9f9; color: #4e4e4e;  border: 1px #e4e4e4 solid; margin-bottom: 5px;">
            <div class="row">
                <div class="col-md-1 col-xs-1" style="padding-left: 20px; padding-right: 0px; text-align: center" ><img src="media/icKota2.png" class="img-logos"></div>
                <div class="col-md-11 col-xs-1" style="padding-left: 1px;">
                    <p class="tittle-logos" style="font-size: 35px; font-weight: bold; font-family: Segoe UI; margin-bottom: 2px">SEMEN PADANG</p>
    ...
    <!--------------------------KONTEN PRODUKSI--------------------------------->
    <a href="<?php echo base_url(); ?>index.php/master_data/padang?bulan=<?php echo date('m');?>&tahun=<?php echo date('Y');?>">
    ...
    <!--------------------------KONTEN STOCK--------------------------------->
    <a href="<?php echo base_url(); ?>index.php/master_data/stock_padang">
        <div class="col-md-2 col-xs-4" style="height:29px; padding: 10px; margin-top: 20px">
            <div class="info-box" style="background: #666; color:#FFFFFF; text-align: center">
    ...
    <!--------------------------KONTEN PROGNOSE --------------------------------->
    <a href="<?php echo base_url(); ?>index.php/master_data/prognose_opco/3">
        <div class="col-md-2 col-xs-4" style="height:29px; padding: 10px; margin-top: 20px">
            <div class="info-box" style="background: #666; color:#FFFFFF; text-align: center">
    ...
    <!--------------------------KONTEN CAPACITY --------------------------------->
    <a href="<?php echo base_url(); ?>index.php/master_data/capacity/3?plant=1&tahun=<?php echo date('Y');?>">
        <div class="col-md-2 col-xs-4" style="height:29px; padding: 10px; margin-top: 20px">
            <div class="info-box" style="background: #666; color:#FFFFFF; text-align: center">
    ...
    <!--------------------------KONTEN RKAP TOTAL --------------------------------->
    <a href="<?php echo base_url(); ?>index.php/master_data/rkap_total/3?tahun=<?php echo date('Y');?>">
        <div class="col-md-2 col-xs-4" style="height:29px; padding: 10px; margin-top: 20px">
            <div class="info-box" style="background: #666; color:#FFFFFF; text-align: center">
    ...
    <!--------------------------KONTEN RKAP PLANT --------------------------------->
    <a href="<?php echo base_url(); ?>index.php/master_data/rkap_plant/3?plant=1&tahun=<?php echo date('Y');?>">
        <div class="col-md-2 col-xs-4" style="height:29px; padding: 10px; margin-top: 20px">
            <div class="info-box" style="background: #666; color:#FFFFFF; text-align: center">
    ...
    <!--------------------------KONTEN KILN OPS --------------------------------->
<!--    <a href="<?php echo base_url(); ?>index.php/master_data/padang">
        <div class="col-md-2 col-xs-4" style="height:29px; padding: 10px; margin-top: 20px">
            <div class="info-box" style="background: #666; color:#FFFFFF; text-align: center">
...
<div class="col-md-12 col-xs-12 col-lg-12">
    <div class="col-xs-6 col-md-6 col-lg-6">
        <div style="text-align: center">
            <a href="plant_system/data_sap_sp" target="_blank"><button class="btn btn-info center">Update Data from SAP</button></a>
        </div>
    </div>
    <div class="col-xs-6 col-md-6 col-lg-6">
        <div style="text-align: center">
        <a href="plant_administrator/mass_upload_padang" ><button class="btn btn-warning center">Excel Mass Upload</button></a>
    </div>
