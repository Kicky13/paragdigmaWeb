...
<script>
    ...
    hot = new Handsontable($container[0], {
        ...
        data: ['DATE_PROD', 'KL1_PROD', 'FMMP_PROD', 'FMHCM_PROD'],
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?= site_url() ?>/master_data/save_prognose_day_tlcc/<?php echo $bulan; ?>/<?php echo $tahun; ?>',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_prognose_day_tlcc/<?php echo $bulan; ?>/<?php echo $tahun; ?>',
            type: 'GET',
            success: function (res) {
                var mine = JSON.parse(res);
                var data = [], row;
                data[0] = ['DATE_PROD', 'KL1_PROD', 'FMMP_PROD', 'FMHCM_PROD'];
    ...
    function Btn_periode(periode) {
        var url = "<?= base_url() ?>index.php/master_data/prognose_opco/5";
