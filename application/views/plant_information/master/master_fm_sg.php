        ...
        <form name="load" id="load" style="width: 100%;">
            <div class="col-md-4 container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="javascript:void(0)">Gresik : FM Operations Report</a>
                </div>
            </div>
...
<script>
    ...
    hot = new Handsontable($container[0], {
        ...
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?= site_url() ?>/master_data/save_fm_sg/<?php echo $bulan; ?>/<?php echo $tahun; ?>/<?php echo $plant; ?>',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_fm_sg/<?php echo $bulan; ?>/<?php echo $tahun; ?>/<?php echo $plant; ?>',
            type: 'GET',
