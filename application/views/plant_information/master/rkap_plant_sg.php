            ...
            <form name="load" id="load" style="width: 100%;">
                <div class="col-md-4" style="padding-left: 0px">
                    <ul class="nav navbar-nav navbar-center">
                        <li class="dropdown">
                            <?php
                            $jenis_arr = array(1 => "Tuban 1", 2 => "Tuban 2", 3 => "Tuban 3", 4 => "Tuban 4", 5 => "Gresik", 6 => "Rembang", 7 => "Cigading");
                            ?>
...
<script>
    ...
    hot = new Handsontable($container[0], {
        ...
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?= site_url() ?>/master_data/save_rkap_plant_sg',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_rkap_plant_sg/<?php echo $pemisah; ?>/<?php echo $plant; ?>/<?php echo $tahun; ?>',
            type: 'GET',
