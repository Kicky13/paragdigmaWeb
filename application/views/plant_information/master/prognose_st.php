            ...
            <form name="load" id="load" style="width: 100%;">
                <div class="col-md-4" style="margin-top: 8px;">
                    <select class="form-control" name="plant" id="plant">
                        <option value="1">Tonasa 2</option>
                        <option value="2">Tonasa 3</option>
                        <option value="3">Tonasa 4.1</option>
                        <option value="4">Tonasa 4.2</option>
                        <option value="5">Tonasa 5.1</option>
                        <option value="6">Tonasa 5.2</option>
                    </select>
                </div>
                <div class="col-md-4" style="margin-top: 8px;">
...
<script>
    ...
    hot = new Handsontable($container[0], {
        ...
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?= site_url() ?>/master_data/save_prognose_st',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_prognose_st/<?php echo $pemisah; ?>/<?php echo $bantu; ?>/<?php echo $bantu2; ?>',
            type: 'GET',
