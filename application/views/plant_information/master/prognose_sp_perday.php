...
<script>
    ...
    hot = new Handsontable($container[0], {
        ...
        data: [
            ['DATE_PROD', 'KL2_PROD', 'KL3_PROD', 'KL4_PROD', 'KL5_PROD', 'FM2_PROD', 'FM3_PROD', 'FM41_PROD', 'FM42_PROD', 'FM51_PROD', 'FM52_PROD', 'FMDM_PROD']
        ],
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?= site_url() ?>/master_data/save_prognose_day_sp/<?php echo $bulan; ?>/<?php echo $tahun; ?>',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_prognose_day_sp/<?php echo $bulan; ?>/<?php echo $tahun; ?>',
            type: 'GET',
            success: function (res) {
                var mine = JSON.parse(res);
                var data = [], row;
                data[0] = ['DATE_PROD', 'KL2_PROD', 'KL3_PROD', 'KL4_PROD', 'KL5_PROD', 'FM2_PROD', 'FM3_PROD', 'FM41_PROD', 'FM42_PROD', 'FM51_PROD', 'FM52_PROD', 'FMDM_PROD'];
    ...
    function Btn_periode(periode) {
        var url = "<?= base_url() ?>index.php/master_data/prognose_opco/3";
