        ...
        <form name="load" id="load" style="width: 100%;">
            <div class="col-md-4 container-fluid">
                <div class="navbar-header">
                    <a class="navbar-brand" href="javascript:void(0)">Padang : FM Operations Report</a>
                </div>
            </div>
            <div class="col-md-7"> <!--   container-fluid -->
                <div class="col-md-4" style="padding-left: 0px">
                    <ul class="nav navbar-nav navbar-center">
                        <li class="dropdown">
                            <?php
                            $jenis_arr = array(1 => "Indarung 2", 2 => "Indarung 3", 3 => "Indarung 4.1", 4 => "Indarung 4.2", 5 => "Indarung 5.1", 6 => "Indarung 5.2", 7 => "Dumai");
                            ?>
...
<script>
    ...
    hot = new Handsontable($container[0], {
        ...
        afterChange: function (change, source) {
            ...
            $.ajax({
                url: '<?= site_url() ?>/master_data/save_fm_sp/<?php echo $bulan; ?>/<?php echo $tahun; ?>/<?php echo $plant; ?>',
                dataType: 'json',
                type: 'POST',
    ...
    $("#load").click(function () {
        $.ajax({
            url: 'master_data/get_fm_sp/<?php echo $bulan; ?>/<?php echo $tahun; ?>/<?php echo $plant; ?>',
            type: 'GET',
