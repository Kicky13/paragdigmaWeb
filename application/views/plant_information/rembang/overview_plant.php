...
<script>
    function dataUpdate() {
        $.ajax({
            url: 'http://par4digma.semenindonesia.com/api/index.php/plant_rembang/get_statefeed',
            type: 'GET',
            success: function (data) {
                ...
                var tlcc_cm_v = parseFloat(dataJson[0].tags[2].props[0].val).toFixed(2);
                var tlcc_kl_v = parseFloat(dataJson[0].tags[4].props[0].val).toFixed(2);
                var tlcc_fm_v = parseFloat(dataJson[0].tags[6].props[0].val).toFixed(2);
                var tlcc_fmhcm_v = parseFloat(dataJson[0].tags[8].props[0].val).toFixed(2);
                ...
                //Raw Mill
                tlcc_rm1 = dataJson[0].tags[1].props[0].val;
                ...
                //Coal Mill
                tlcc_cm1 = dataJson[0].tags[3].props[0].val;
                ...
                //KILN
                tlcc_kl1 = dataJson[0].tags[5].props[0].val;
                ...
                //Finish Mill
                tlcc_fm1 = dataJson[0].tags[7].props[0].val;
...
<div class="row plant_cover">
    ...
    <div class="col-xs-12 col-md-4 noPadding">
        <div class="col-xs-12 noPadding plant-head" style="background-color: #ffa83c; height: 90px;">
            ...
            <div class="col-xs-8"><p class="p-plant">Rembang</p><br><p class="p-numb">1</p></div>					
        </div>
        ...
        <div class="col-xs-12 noPadding" >
            <div class="img-thumbnail cubesRun" style="border-left: 3px solid #ffa83c;" >
                <div class="col-xs-10" style="text-align: center;"><div class="TagName">Finish Mill 1</div>
        ...
        <div class="col-xs-12 noPadding" >
            <div class="img-thumbnail cubesRun" style="border-left: 3px solid #ffa83c; border-bottom: 3px solid #ffa83c;" >
                <div class="col-xs-10" style="text-align: center;"><div class="TagName">Finish Mill 2</div>
